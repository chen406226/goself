...
//go:build avr && at90pwm3b
// +build avr,at90pwm3b

// Device information for the AT90PWM3B.
package avr
...
var (
	...
	PICR1L  = (*volatile.Register8)(unsafe.Pointer(uintptr(0xee)))
	PICR1H  = (*volatile.Register8)(unsafe.Pointer(uintptr(0xef)))
	PFRC1B  = (*volatile.Register8)(unsafe.Pointer(uintptr(0xed)))
	PFRC1A  = (*volatile.Register8)(unsafe.Pointer(uintptr(0xec)))
	PCTL1   = (*volatile.Register8)(unsafe.Pointer(uintptr(0xeb)))
	PCNF1   = (*volatile.Register8)(unsafe.Pointer(uintptr(0xea)))
	OCR1RBL = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe8)))
	OCR1RBH = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe9)))
	OCR1SBL = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe6)))
	OCR1SBH = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe7)))
	OCR1RAL = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe4)))
	OCR1RAH = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe5)))
	OCR1SAL = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe2)))
	OCR1SAH = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe3)))
	PSOC1   = (*volatile.Register8)(unsafe.Pointer(uintptr(0xe0)))
	PIM1    = (*volatile.Register8)(unsafe.Pointer(uintptr(0xa3)))
	PIFR1   = (*volatile.Register8)(unsafe.Pointer(uintptr(0xa2)))
...
const (
	...
	OCR1A_OCR1A0 = 0x1  // Timer/Counter1 Output Compare A
	OCR1A_OCR1A1 = 0x2  // Timer/Counter1 Output Compare A
	OCR1A_OCR1A2 = 0x4  // Timer/Counter1 Output Compare A
	OCR1A_OCR1A3 = 0x8  // Timer/Counter1 Output Compare A
	OCR1A_OCR1A4 = 0x10 // Timer/Counter1 Output Compare A
	OCR1A_OCR1A5 = 0x20 // Timer/Counter1 Output Compare A
	OCR1A_OCR1A6 = 0x40 // Timer/Counter1 Output Compare A
	OCR1A_OCR1A7 = 0x80 // Timer/Counter1 Output Compare A

	// OCR1BL: Timer/Counter1 Output Compare Register  Bytes

	// OCR1BH: Timer/Counter1 Output Compare Register  Bytes
	OCR1B_OCR1B0 = 0x1  // Timer/Counter1 Output Compare B
	OCR1B_OCR1B1 = 0x2  // Timer/Counter1 Output Compare B
	OCR1B_OCR1B2 = 0x4  // Timer/Counter1 Output Compare B
	OCR1B_OCR1B3 = 0x8  // Timer/Counter1 Output Compare B
	OCR1B_OCR1B4 = 0x10 // Timer/Counter1 Output Compare B
	OCR1B_OCR1B5 = 0x20 // Timer/Counter1 Output Compare B
	OCR1B_OCR1B6 = 0x40 // Timer/Counter1 Output Compare B
	OCR1B_OCR1B7 = 0x80 // Timer/Counter1 Output Compare B
...
const (
	...
	PICR1_PICR10 = 0x1    // PSC 1 Input Capture Bytes
	PICR1_PICR11 = 0x2    // PSC 1 Input Capture Bytes
	PICR1_PICR12 = 0x4    // PSC 1 Input Capture Bytes
	PICR1_PICR13 = 0x8    // PSC 1 Input Capture Bytes
	PICR1_PICR14 = 0x10   // PSC 1 Input Capture Bytes
	PICR1_PICR15 = 0x20   // PSC 1 Input Capture Bytes
	PICR1_PICR16 = 0x40   // PSC 1 Input Capture Bytes
	PICR1_PICR17 = 0x80   // PSC 1 Input Capture Bytes
	...
	PFRC1B_PRFM1B0 = 0x1  // PSC 1 Retrigger and Fault Mode for Part B
	PFRC1B_PRFM1B1 = 0x2  // PSC 1 Retrigger and Fault Mode for Part B
	PFRC1B_PRFM1B2 = 0x4  // PSC 1 Retrigger and Fault Mode for Part B
	PFRC1B_PRFM1B3 = 0x8  // PSC 1 Retrigger and Fault Mode for Part B
	...
	PFRC1A_PRFM1A0 = 0x1  // PSC 1 Retrigger and Fault Mode for Part A
	PFRC1A_PRFM1A1 = 0x2  // PSC 1 Retrigger and Fault Mode for Part A
	PFRC1A_PRFM1A2 = 0x4  // PSC 1 Retrigger and Fault Mode for Part A
	PFRC1A_PRFM1A3 = 0x8  // PSC 1 Retrigger and Fault Mode for Part A

	// PCTL1: PSC 1 Control Register
	PCTL1_PPRE10 = 0x40 // PSC 1 Prescaler Selects
	PCTL1_PPRE11 = 0x80 // PSC 1 Prescaler Selects
	...
	PCNF1_PMODE10  = 0x8  // PSC 1 Mode
	PCNF1_PMODE11  = 0x10 // PSC 1 Mode
	PCNF1_POP1     = 0x4  // PSC 1 Output Polarity
	PCNF1_PCLKSEL1 = 0x2  // PSC 1 Input Clock Select

	// OCR1RBL: Output Compare RB Register

	// OCR1RBH: Output Compare RB Register
	OCR1RB_OCR1RB0 = 0x1  // Output Compare 1 RB
	OCR1RB_OCR1RB1 = 0x2  // Output Compare 1 RB
	OCR1RB_OCR1RB2 = 0x4  // Output Compare 1 RB
	OCR1RB_OCR1RB3 = 0x8  // Output Compare 1 RB
	OCR1RB_OCR1RB4 = 0x10 // Output Compare 1 RB
	OCR1RB_OCR1RB5 = 0x20 // Output Compare 1 RB
	OCR1RB_OCR1RB6 = 0x40 // Output Compare 1 RB
	OCR1RB_OCR1RB7 = 0x80 // Output Compare 1 RB

	// OCR1SBL: Output Compare SB Register

	// OCR1SBH: Output Compare SB Register
	OCR1SB_OCR1SB0 = 0x1  // Output Compare 1 SB
	OCR1SB_OCR1SB1 = 0x2  // Output Compare 1 SB
	OCR1SB_OCR1SB2 = 0x4  // Output Compare 1 SB
	OCR1SB_OCR1SB3 = 0x8  // Output Compare 1 SB
	OCR1SB_OCR1SB4 = 0x10 // Output Compare 1 SB
	OCR1SB_OCR1SB5 = 0x20 // Output Compare 1 SB
	OCR1SB_OCR1SB6 = 0x40 // Output Compare 1 SB
	OCR1SB_OCR1SB7 = 0x80 // Output Compare 1 SB

	// OCR1RAL: Output Compare RA Register

	// OCR1RAH: Output Compare RA Register
	OCR1RA_OCR1RA0 = 0x1  // Output Compare 1 RA
	OCR1RA_OCR1RA1 = 0x2  // Output Compare 1 RA
	OCR1RA_OCR1RA2 = 0x4  // Output Compare 1 RA
	OCR1RA_OCR1RA3 = 0x8  // Output Compare 1 RA
	OCR1RA_OCR1RA4 = 0x10 // Output Compare 1 RA
	OCR1RA_OCR1RA5 = 0x20 // Output Compare 1 RA
	OCR1RA_OCR1RA6 = 0x40 // Output Compare 1 RA
	OCR1RA_OCR1RA7 = 0x80 // Output Compare 1 RA

	// OCR1SAL: Output Compare SA Register

	// OCR1SAH: Output Compare SA Register
	OCR1SA_OCR1SA0 = 0x1  // Output Compare 1 SA
	OCR1SA_OCR1SA1 = 0x2  // Output Compare 1 SA
	OCR1SA_OCR1SA2 = 0x4  // Output Compare 1 SA
	OCR1SA_OCR1SA3 = 0x8  // Output Compare 1 SA
	OCR1SA_OCR1SA4 = 0x10 // Output Compare 1 SA
	OCR1SA_OCR1SA5 = 0x20 // Output Compare 1 SA
	OCR1SA_OCR1SA6 = 0x40 // Output Compare 1 SA
	OCR1SA_OCR1SA7 = 0x80 // Output Compare 1 SA

	// PSOC1: PSC1 Synchro and Output Configuration
	PSOC1_PSYNC1_0 = 0x10 // Synchronization Out for ADC Selection
	PSOC1_PSYNC1_1 = 0x20 // Synchronization Out for ADC Selection
	...
	PIFR1_PRN10  = 0x2  // Ramp Number
	PIFR1_PRN11  = 0x4  // Ramp Number
