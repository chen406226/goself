...
const (
	...
	EIMSK_PCIE0 = 0x40 // Pin Change Interrupt Enables
	EIMSK_PCIE1 = 0x80 // Pin Change Interrupt Enables
	EIMSK_INT0  = 0x1  // External Interrupt Request 0 Enable

	// EIFR: External Interrupt Flag Register
	EIFR_PCIF0 = 0x40 // Pin Change Interrupt Flags
	EIFR_PCIF1 = 0x80 // Pin Change Interrupt Flags
