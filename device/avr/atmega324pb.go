...
// Generated by gen-device-avr.go from ATmega324PB.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega324pb
...
//export __vector_PCINT4
//go:interrupt
func interruptPCINT4() {
	callHandlers(IRQ_PCINT4)
}

//export __vector_XOSCFD
//go:interrupt
func interruptXOSCFD() {
	callHandlers(IRQ_XOSCFD)
}
...
//export __vector_USART2_RXS
//go:interrupt
func interruptUSART2_RXS() {
	callHandlers(IRQ_USART2_RXS)
}

//export __vector_USART2_START
//go:interrupt
func interruptUSART2_START() {
	callHandlers(IRQ_USART2_START)
}
...
var (
	...
	UCSR2D = (*volatile.Register8)(unsafe.Pointer(uintptr(0xd3)))
	...
	PCMSK4 = (*volatile.Register8)(unsafe.Pointer(uintptr(0x75)))
...
const (
	...
	UCSR0C_UMSEL1 = 0x80 // USART Mode Select
	UCSR0C_UPM0   = 0x10 // Parity Mode Bits
	UCSR0C_UPM1   = 0x20 // Parity Mode Bits
	UCSR0C_USBS   = 0x8  // Stop Bit Select
	UCSR0C_UCSZ0  = 0x2  // Character Size
	UCSR0C_UCSZ1  = 0x4  // Character Size
	...
	UCSR1C_UMSEL0 = 0x40 // USART Mode Select
	UCSR1C_UMSEL1 = 0x80 // USART Mode Select
	UCSR1C_UPM0   = 0x10 // Parity Mode Bits
	UCSR1C_UPM1   = 0x20 // Parity Mode Bits
	UCSR1C_USBS   = 0x8  // Stop Bit Select
	UCSR1C_UCSZ0  = 0x2  // Character Size
	UCSR1C_UCSZ1  = 0x4  // Character Size
	...
	UCSR2C_UMSEL0 = 0x40 // USART Mode Select
	UCSR2C_UMSEL1 = 0x80 // USART Mode Select
	UCSR2C_UPM0   = 0x10 // Parity Mode Bits
	UCSR2C_UPM1   = 0x20 // Parity Mode Bits
	UCSR2C_USBS   = 0x8  // Stop Bit Select
	UCSR2C_UCSZ0  = 0x2  // Character Size
	UCSR2C_UCSZ1  = 0x4  // Character Size
...
const (
	...
	PCMSK4_PCINT0 = 0x1  // Pin Change Enable Masks
	PCMSK4_PCINT1 = 0x2  // Pin Change Enable Masks
	PCMSK4_PCINT2 = 0x4  // Pin Change Enable Masks
	PCMSK4_PCINT3 = 0x8  // Pin Change Enable Masks
	PCMSK4_PCINT4 = 0x10 // Pin Change Enable Masks
	PCMSK4_PCINT5 = 0x20 // Pin Change Enable Masks
	PCMSK4_PCINT6 = 0x40 // Pin Change Enable Masks
	...
	PCIFR_PCIF4 = 0x10 // Pin Change Interrupt Flags
	...
	PCICR_PCIE4 = 0x10 // Pin Change Interrupt Enables
)
...
const (
	...
	TCCR3A_COM3B0 = 0x10 // Compare Output Mode 1B, bits
	TCCR3A_COM3B1 = 0x20 // Compare Output Mode 1B, bits
	...
	TCCR3B_WGM30 = 0x8  // Waveform Generation Mode Bits
	TCCR3B_WGM31 = 0x10 // Waveform Generation Mode Bits
	TCCR3B_CS30  = 0x1  // Clock Select1 bits
	TCCR3B_CS31  = 0x2  // Clock Select1 bits
	TCCR3B_CS32  = 0x4  // Clock Select1 bits
	...
	TCCR4A_COM4B0 = 0x10 // Compare Output Mode 1B, bits
	TCCR4A_COM4B1 = 0x20 // Compare Output Mode 1B, bits
	TCCR4A_WGM40  = 0x1  // Pulse Width Modulator Select Bits
	TCCR4A_WGM41  = 0x2  // Pulse Width Modulator Select Bits

	// TCCR4B: Timer/Counter4 Control Register B
	TCCR4B_ICNC4 = 0x80 // Input Capture 1 Noise Canceler
	TCCR4B_ICES4 = 0x40 // Input Capture 1 Edge Select
	TCCR4B_WGM40 = 0x8  // Waveform Generation Mode Bits
	TCCR4B_WGM41 = 0x10 // Waveform Generation Mode Bits
	TCCR4B_CS40  = 0x1  // Clock Select1 bits
	TCCR4B_CS41  = 0x2  // Clock Select1 bits
	TCCR4B_CS42  = 0x4  // Clock Select1 bits
...
const (
	...
	SPCR0_SPR0 = 0x1  // SPI Clock Rate Select
	SPCR0_SPR1 = 0x2  // SPI Clock Rate Select
	...
	SPCR1_SPR0 = 0x1  // SPI Clock Rate Select
	SPCR1_SPR1 = 0x2  // SPI Clock Rate Select
)
...
const (
	...
	TWSR0_TWS00 = 0x8  // TWI Status
	TWSR0_TWS01 = 0x10 // TWI Status
	TWSR0_TWS02 = 0x20 // TWI Status
	TWSR0_TWS03 = 0x40 // TWI Status
	TWSR0_TWS04 = 0x80 // TWI Status
	...
	TWSR1_TWS00 = 0x8  // TWI Status
	TWSR1_TWS01 = 0x10 // TWI Status
	TWSR1_TWS02 = 0x20 // TWI Status
	TWSR1_TWS03 = 0x40 // TWI Status
	TWSR1_TWS04 = 0x80 // TWI Status
	TWSR1_TWPS0 = 0x1  // TWI Prescaler
	TWSR1_TWPS1 = 0x2  // TWI Prescaler

	// TWAR1: TWI (Slave) Address register
	TWAR1_TWA0  = 0x2  // TWI (Slave) Address register Bits
	TWAR1_TWA1  = 0x4  // TWI (Slave) Address register Bits
	TWAR1_TWA2  = 0x8  // TWI (Slave) Address register Bits
	TWAR1_TWA3  = 0x10 // TWI (Slave) Address register Bits
	TWAR1_TWA4  = 0x20 // TWI (Slave) Address register Bits
	TWAR1_TWA5  = 0x40 // TWI (Slave) Address register Bits
	TWAR1_TWA6  = 0x80 // TWI (Slave) Address register Bits
