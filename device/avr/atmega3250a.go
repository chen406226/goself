...
// Generated by gen-device-avr.go from ATmega3250A.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega3250a
// +build avr,atmega3250a

// Device information for the ATmega3250A.
package avr
...
//export __vector_NOT_USED
//go:interrupt
func interruptNOT_USED() {
	callHandlers(IRQ_NOT_USED)
}
...
const (
	...
	PCMSK3_PCINT0 = 0x1  // Pin Change Mask bits
	PCMSK3_PCINT1 = 0x2  // Pin Change Mask bits
	PCMSK3_PCINT2 = 0x4  // Pin Change Mask bits
	PCMSK3_PCINT3 = 0x8  // Pin Change Mask bits
	PCMSK3_PCINT4 = 0x10 // Pin Change Mask bits
	PCMSK3_PCINT5 = 0x20 // Pin Change Mask bits
	PCMSK3_PCINT6 = 0x40 // Pin Change Mask bits

	// PCMSK2: Pin Change Mask Register 2
	PCMSK2_PCINT0 = 0x1  // Pin Change Mask bits
	PCMSK2_PCINT1 = 0x2  // Pin Change Mask bits
	PCMSK2_PCINT2 = 0x4  // Pin Change Mask bits
	PCMSK2_PCINT3 = 0x8  // Pin Change Mask bits
	PCMSK2_PCINT4 = 0x10 // Pin Change Mask bits
	PCMSK2_PCINT5 = 0x20 // Pin Change Mask bits
	PCMSK2_PCINT6 = 0x40 // Pin Change Mask bits
	PCMSK2_PCINT7 = 0x80 // Pin Change Mask bits

	// PCMSK1: Pin Change Mask Register 1
	PCMSK1_PCINT0 = 0x1  // Pin Change Mask bits
	PCMSK1_PCINT1 = 0x2  // Pin Change Mask bits
	PCMSK1_PCINT2 = 0x4  // Pin Change Mask bits
	PCMSK1_PCINT3 = 0x8  // Pin Change Mask bits
	PCMSK1_PCINT4 = 0x10 // Pin Change Mask bits
	PCMSK1_PCINT5 = 0x20 // Pin Change Mask bits
	PCMSK1_PCINT6 = 0x40 // Pin Change Mask bits
	PCMSK1_PCINT7 = 0x80 // Pin Change Mask bits

	// PCMSK0: Pin Change Mask Register 0
	PCMSK0_PCINT0 = 0x1  // Pin Change Mask bits
	PCMSK0_PCINT1 = 0x2  // Pin Change Mask bits
	PCMSK0_PCINT2 = 0x4  // Pin Change Mask bits
	PCMSK0_PCINT3 = 0x8  // Pin Change Mask bits
	PCMSK0_PCINT4 = 0x10 // Pin Change Mask bits
	PCMSK0_PCINT5 = 0x20 // Pin Change Mask bits
	PCMSK0_PCINT6 = 0x40 // Pin Change Mask bits
	PCMSK0_PCINT7 = 0x80 // Pin Change Mask bits
)
