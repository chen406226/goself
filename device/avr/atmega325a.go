...
// Generated by gen-device-avr.go from ATmega325A.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega325a
// +build avr,atmega325a

// Device information for the ATmega325A.
package avr
