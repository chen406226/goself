...
// Generated by gen-device-avr.go from ATmega325P.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega325p
// +build avr,atmega325p

// Device information for the ATmega325P.
package avr
