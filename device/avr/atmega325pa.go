...
// Generated by gen-device-avr.go from ATmega325PA.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega325pa
// +build avr,atmega325pa

// Device information for the ATmega325PA.
package avr
