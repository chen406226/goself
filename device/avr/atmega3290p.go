...
// Generated by gen-device-avr.go from ATmega3290P.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega3290p
// +build avr,atmega3290p

// Device information for the ATmega3290P.
package avr
...
var (
	...
	LCDDR09 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xf5)))
	...
	LCDDR04 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xf0)))
...
const (
	...
	LCDCCR_LCDDC0 = 0x20 // LCD Display Configurations
	LCDCCR_LCDDC1 = 0x40 // LCD Display Configurations
	LCDCCR_LCDDC2 = 0x80 // LCD Display Configurations
	LCDCCR_LCDMDT = 0x10 // LCD Maximum Drive Time
	LCDCCR_LCDCC0 = 0x1  // LCD Contrast Control
	LCDCCR_LCDCC1 = 0x2  // LCD Contrast Control
	LCDCCR_LCDCC2 = 0x4  // LCD Contrast Control
	LCDCCR_LCDCC3 = 0x8  // LCD Contrast Control
...
const (
	...
	PCMSK3_PCINT0 = 0x1  // Pin Change Mask
	PCMSK3_PCINT1 = 0x2  // Pin Change Mask
	PCMSK3_PCINT2 = 0x4  // Pin Change Mask
	PCMSK3_PCINT3 = 0x8  // Pin Change Mask
	PCMSK3_PCINT4 = 0x10 // Pin Change Mask
	PCMSK3_PCINT5 = 0x20 // Pin Change Mask
	PCMSK3_PCINT6 = 0x40 // Pin Change Mask

	// PCMSK2: Pin Change Mask Register 2
	PCMSK2_PCINT0 = 0x1  // Pin Change Mask
	PCMSK2_PCINT1 = 0x2  // Pin Change Mask
	PCMSK2_PCINT2 = 0x4  // Pin Change Mask
	PCMSK2_PCINT3 = 0x8  // Pin Change Mask
	PCMSK2_PCINT4 = 0x10 // Pin Change Mask
	PCMSK2_PCINT5 = 0x20 // Pin Change Mask
	PCMSK2_PCINT6 = 0x40 // Pin Change Mask
	PCMSK2_PCINT7 = 0x80 // Pin Change Mask
