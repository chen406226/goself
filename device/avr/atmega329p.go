...
// Generated by gen-device-avr.go from ATmega329P.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega329p
// +build avr,atmega329p

// Device information for the ATmega329P.
package avr
...
const (
	...
	PCMSK1_PCINT8  = 0x1  // Pin Change Mask Register pin 8
	PCMSK1_PCINT9  = 0x2  // Pin Change Mask Register pin 9
	PCMSK1_PCINT10 = 0x4  // Pin Change Mask Register pin 10
	PCMSK1_PCINT11 = 0x8  // Pin Change Mask Register pin 11
	PCMSK1_PCINT12 = 0x10 // Pin Change Mask Register pin 12
	PCMSK1_PCINT13 = 0x20 // Pin Change Mask Register pin 13
	PCMSK1_PCINT14 = 0x40 // Pin Change Mask Register pin 14
	PCMSK1_PCINT15 = 0x80 // Pin Change Mask Register pin 15

	// PCMSK0: Pin Change Mask Register 0
	PCMSK0_PCINT0 = 0x1  // Pin Change Mask Register pin 0
	PCMSK0_PCINT1 = 0x2  // Pin Change Mask Register pin 1
	PCMSK0_PCINT2 = 0x4  // Pin Change Mask Register pin 2
	PCMSK0_PCINT3 = 0x8  // Pin Change Mask Register pin 3
	PCMSK0_PCINT4 = 0x10 // Pin Change Mask Register pin 4
	PCMSK0_PCINT5 = 0x20 // Pin Change Mask Register pin 5
	PCMSK0_PCINT6 = 0x40 // Pin Change Mask Register pin 6
	PCMSK0_PCINT7 = 0x80 // Pin Change Mask Register pin 7
)
...
const (
	...
	LCDDR8_SEG124 = 0x1  // LCD memory bit segment
	LCDDR8_SEG125 = 0x2  // LCD memory bit segment
	LCDDR8_SEG126 = 0x4  // LCD memory bit segment
	LCDDR8_SEG127 = 0x8  // LCD memory bit segment
	LCDDR8_SEG128 = 0x10 // LCD memory bit segment
	LCDDR8_SEG129 = 0x20 // LCD memory bit segment
	LCDDR8_SEG130 = 0x40 // LCD memory bit segment
	LCDDR8_SEG131 = 0x80 // LCD memory bit segment

	// LCDDR7: LCD Data Register 7
	LCDDR7_SEG116 = 0x1  // LCD memory bit segment
	LCDDR7_SEG117 = 0x2  // LCD memory bit segment
	LCDDR7_SEG118 = 0x4  // LCD memory bit segment
	LCDDR7_SEG119 = 0x8  // LCD memory bit segment
	LCDDR7_SEG120 = 0x10 // LCD memory bit segment
	LCDDR7_SEG121 = 0x20 // LCD memory bit segment
	LCDDR7_SEG122 = 0x40 // LCD memory bit segment
	LCDDR7_SEG123 = 0x80 // LCD memory bit segment

	// LCDDR6: LCD Data Register 6
	LCDDR6_SEG108 = 0x1  // LCD memory bit segment
	LCDDR6_SEG109 = 0x2  // LCD memory bit segment
	LCDDR6_SEG110 = 0x4  // LCD memory bit segment
	LCDDR6_SEG111 = 0x8  // LCD memory bit segment
	LCDDR6_SEG112 = 0x10 // LCD memory bit segment
	LCDDR6_SEG113 = 0x20 // LCD memory bit segment
	LCDDR6_SEG114 = 0x40 // LCD memory bit segment
	LCDDR6_SEG115 = 0x80 // LCD memory bit segment

	// LCDDR5: LCD Data Register 5
	LCDDR5_SEG100 = 0x1  // LCD memory bit segment
	LCDDR5_SEG101 = 0x2  // LCD memory bit segment
	LCDDR5_SEG102 = 0x4  // LCD memory bit segment
	LCDDR5_SEG103 = 0x8  // LCD memory bit segment
	LCDDR5_SEG104 = 0x10 // LCD memory bit segment
	LCDDR5_SEG105 = 0x20 // LCD memory bit segment
	LCDDR5_SEG106 = 0x40 // LCD memory bit segment
	LCDDR5_SEG107 = 0x80 // LCD memory bit segment

	// LCDDR3: LCD Data Register 3
	LCDDR3_SEG024 = 0x1  // LCD memory bit segment
	LCDDR3_SEG025 = 0x2  // LCD memory bit segment
	LCDDR3_SEG026 = 0x4  // LCD memory bit segment
	LCDDR3_SEG027 = 0x8  // LCD memory bit segment
	LCDDR3_SEG028 = 0x10 // LCD memory bit segment
	LCDDR3_SEG029 = 0x20 // LCD memory bit segment
	LCDDR3_SEG030 = 0x40 // LCD memory bit segment
	LCDDR3_SEG031 = 0x80 // LCD memory bit segment

	// LCDDR2: LCD Data Register 2
	LCDDR2_SEG016 = 0x1  // LCD memory bit segment
	LCDDR2_SEG017 = 0x2  // LCD memory bit segment
	LCDDR2_SEG018 = 0x4  // LCD memory bit segment
	LCDDR2_SEG019 = 0x8  // LCD memory bit segment
	LCDDR2_SEG020 = 0x10 // LCD memory bit segment
	LCDDR2_SEG021 = 0x20 // LCD memory bit segment
	LCDDR2_SEG022 = 0x40 // LCD memory bit segment
	LCDDR2_SEG023 = 0x80 // LCD memory bit segment

	// LCDDR1: LCD Data Register 1
	LCDDR1_SEG008 = 0x1  // LCD memory bit segment
	LCDDR1_SEG009 = 0x2  // LCD memory bit segment
	LCDDR1_SEG010 = 0x4  // LCD memory bit segment
	LCDDR1_SEG011 = 0x8  // LCD memory bit segment
	LCDDR1_SEG012 = 0x10 // LCD memory bit segment
	LCDDR1_SEG013 = 0x20 // LCD memory bit segment
	LCDDR1_SEG014 = 0x40 // LCD memory bit segment
	LCDDR1_SEG015 = 0x80 // LCD memory bit segment

	// LCDDR0: LCD Data Register 0
	LCDDR0_SEG000 = 0x1  // LCD memory bit segment
	LCDDR0_SEG001 = 0x2  // LCD memory bit segment
	LCDDR0_SEG002 = 0x4  // LCD memory bit segment
	LCDDR0_SEG003 = 0x8  // LCD memory bit segment
	LCDDR0_SEG004 = 0x10 // LCD memory bit segment
	LCDDR0_SEG005 = 0x20 // LCD memory bit segment
	LCDDR0_SEG006 = 0x40 // LCD memory bit segment
	LCDDR0_SEG007 = 0x80 // LCD memory bit segment
