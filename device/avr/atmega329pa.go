...
// Generated by gen-device-avr.go from ATmega329PA.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega329pa
// +build avr,atmega329pa

// Device information for the ATmega329PA.
package avr
...
var (
	...
	LCDDR08 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xf4)))
	LCDDR07 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xf3)))
	LCDDR06 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xf2)))
	LCDDR05 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xf1)))
	LCDDR03 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xef)))
	LCDDR02 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xee)))
	LCDDR01 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xed)))
	LCDDR00 = (*volatile.Register8)(unsafe.Pointer(uintptr(0xec)))
...
const (
	...
	LCDDR18_SEG324 = 0x1  // LCD memory bit segment
	LCDDR18_SEG325 = 0x2  // LCD memory bit segment
	LCDDR18_SEG326 = 0x4  // LCD memory bit segment
	LCDDR18_SEG327 = 0x8  // LCD memory bit segment
	LCDDR18_SEG328 = 0x10 // LCD memory bit segment
	LCDDR18_SEG329 = 0x20 // LCD memory bit segment
	LCDDR18_SEG330 = 0x40 // LCD memory bit segment
	LCDDR18_SEG331 = 0x80 // LCD memory bit segment

	// LCDDR17: LCD Data Register 17
	LCDDR17_SEG316 = 0x1  // LCD memory bit segment
	LCDDR17_SEG317 = 0x2  // LCD memory bit segment
	LCDDR17_SEG318 = 0x4  // LCD memory bit segment
	LCDDR17_SEG319 = 0x8  // LCD memory bit segment
	LCDDR17_SEG320 = 0x10 // LCD memory bit segment
	LCDDR17_SEG321 = 0x20 // LCD memory bit segment
	LCDDR17_SEG322 = 0x40 // LCD memory bit segment
	LCDDR17_SEG323 = 0x80 // LCD memory bit segment

	// LCDDR16: LCD Data Register 16
	LCDDR16_SEG308 = 0x1  // LCD memory bit segment
	LCDDR16_SEG309 = 0x2  // LCD memory bit segment
	LCDDR16_SEG310 = 0x4  // LCD memory bit segment
	LCDDR16_SEG311 = 0x8  // LCD memory bit segment
	LCDDR16_SEG312 = 0x10 // LCD memory bit segment
	LCDDR16_SEG313 = 0x20 // LCD memory bit segment
	LCDDR16_SEG314 = 0x40 // LCD memory bit segment
	LCDDR16_SEG315 = 0x80 // LCD memory bit segment

	// LCDDR15: LCD Data Register 15
	LCDDR15_SEG300 = 0x1  // LCD memory bit segment
	LCDDR15_SEG301 = 0x2  // LCD memory bit segment
	LCDDR15_SEG302 = 0x4  // LCD memory bit segment
	LCDDR15_SEG303 = 0x8  // LCD memory bit segment
	LCDDR15_SEG304 = 0x10 // LCD memory bit segment
	LCDDR15_SEG305 = 0x20 // LCD memory bit segment
	LCDDR15_SEG306 = 0x40 // LCD memory bit segment
	LCDDR15_SEG307 = 0x80 // LCD memory bit segment

	// LCDDR13: LCD Data Register 13
	LCDDR13_SEG224 = 0x1  // LCD memory bit segment
	LCDDR13_SEG225 = 0x2  // LCD memory bit segment
	LCDDR13_SEG226 = 0x4  // LCD memory bit segment
	LCDDR13_SEG227 = 0x8  // LCD memory bit segment
	LCDDR13_SEG228 = 0x10 // LCD memory bit segment
	LCDDR13_SEG229 = 0x20 // LCD memory bit segment
	LCDDR13_SEG230 = 0x40 // LCD memory bit segment
	LCDDR13_SEG231 = 0x80 // LCD memory bit segment

	// LCDDR12: LCD Data Register 12
	LCDDR12_SEG216 = 0x1  // LCD memory bit segment
	LCDDR12_SEG217 = 0x2  // LCD memory bit segment
	LCDDR12_SEG218 = 0x4  // LCD memory bit segment
	LCDDR12_SEG219 = 0x8  // LCD memory bit segment
	LCDDR12_SEG220 = 0x10 // LCD memory bit segment
	LCDDR12_SEG221 = 0x20 // LCD memory bit segment
	LCDDR12_SEG222 = 0x40 // LCD memory bit segment
	LCDDR12_SEG223 = 0x80 // LCD memory bit segment

	// LCDDR11: LCD Data Register 11
	LCDDR11_SEG208 = 0x1  // LCD memory bit segment
	LCDDR11_SEG209 = 0x2  // LCD memory bit segment
	LCDDR11_SEG210 = 0x4  // LCD memory bit segment
	LCDDR11_SEG211 = 0x8  // LCD memory bit segment
	LCDDR11_SEG212 = 0x10 // LCD memory bit segment
	LCDDR11_SEG213 = 0x20 // LCD memory bit segment
	LCDDR11_SEG214 = 0x40 // LCD memory bit segment
	LCDDR11_SEG215 = 0x80 // LCD memory bit segment

	// LCDDR10: LCD Data Register 10
	LCDDR10_SEG200 = 0x1  // LCD memory bit segment
	LCDDR10_SEG201 = 0x2  // LCD memory bit segment
	LCDDR10_SEG202 = 0x4  // LCD memory bit segment
	LCDDR10_SEG203 = 0x8  // LCD memory bit segment
	LCDDR10_SEG204 = 0x10 // LCD memory bit segment
	LCDDR10_SEG205 = 0x20 // LCD memory bit segment
	LCDDR10_SEG206 = 0x40 // LCD memory bit segment
	LCDDR10_SEG207 = 0x80 // LCD memory bit segment

	// LCDDR08: LCD Data Register 8
	LCDDR08_SEG124 = 0x1  // LCD memory bit segment
	LCDDR08_SEG125 = 0x2  // LCD memory bit segment
	LCDDR08_SEG126 = 0x4  // LCD memory bit segment
	LCDDR08_SEG127 = 0x8  // LCD memory bit segment
	LCDDR08_SEG128 = 0x10 // LCD memory bit segment
	LCDDR08_SEG129 = 0x20 // LCD memory bit segment
	LCDDR08_SEG130 = 0x40 // LCD memory bit segment
	LCDDR08_SEG131 = 0x80 // LCD memory bit segment

	// LCDDR07: LCD Data Register 7
	LCDDR07_SEG116 = 0x1  // LCD memory bit segment
	LCDDR07_SEG117 = 0x2  // LCD memory bit segment
	LCDDR07_SEG118 = 0x4  // LCD memory bit segment
	LCDDR07_SEG119 = 0x8  // LCD memory bit segment
	LCDDR07_SEG120 = 0x10 // LCD memory bit segment
	LCDDR07_SEG121 = 0x20 // LCD memory bit segment
	LCDDR07_SEG122 = 0x40 // LCD memory bit segment
	LCDDR07_SEG123 = 0x80 // LCD memory bit segment

	// LCDDR06: LCD Data Register 6
	LCDDR06_SEG108 = 0x1  // LCD memory bit segment
	LCDDR06_SEG109 = 0x2  // LCD memory bit segment
	LCDDR06_SEG110 = 0x4  // LCD memory bit segment
	LCDDR06_SEG111 = 0x8  // LCD memory bit segment
	LCDDR06_SEG112 = 0x10 // LCD memory bit segment
	LCDDR06_SEG113 = 0x20 // LCD memory bit segment
	LCDDR06_SEG114 = 0x40 // LCD memory bit segment
	LCDDR06_SEG115 = 0x80 // LCD memory bit segment

	// LCDDR05: LCD Data Register 5
	LCDDR05_SEG100 = 0x1  // LCD memory bit segment
	LCDDR05_SEG101 = 0x2  // LCD memory bit segment
	LCDDR05_SEG102 = 0x4  // LCD memory bit segment
	LCDDR05_SEG103 = 0x8  // LCD memory bit segment
	LCDDR05_SEG104 = 0x10 // LCD memory bit segment
	LCDDR05_SEG105 = 0x20 // LCD memory bit segment
	LCDDR05_SEG106 = 0x40 // LCD memory bit segment
	LCDDR05_SEG107 = 0x80 // LCD memory bit segment

	// LCDDR03: LCD Data Register 3
	LCDDR03_SEG024 = 0x1  // LCD memory bit segment
	LCDDR03_SEG025 = 0x2  // LCD memory bit segment
	LCDDR03_SEG026 = 0x4  // LCD memory bit segment
	LCDDR03_SEG027 = 0x8  // LCD memory bit segment
	LCDDR03_SEG028 = 0x10 // LCD memory bit segment
	LCDDR03_SEG029 = 0x20 // LCD memory bit segment
	LCDDR03_SEG030 = 0x40 // LCD memory bit segment
	LCDDR03_SEG031 = 0x80 // LCD memory bit segment

	// LCDDR02: LCD Data Register 2
	LCDDR02_SEG016 = 0x1  // LCD memory bit segment
	LCDDR02_SEG017 = 0x2  // LCD memory bit segment
	LCDDR02_SEG018 = 0x4  // LCD memory bit segment
	LCDDR02_SEG019 = 0x8  // LCD memory bit segment
	LCDDR02_SEG020 = 0x10 // LCD memory bit segment
	LCDDR02_SEG021 = 0x20 // LCD memory bit segment
	LCDDR02_SEG022 = 0x40 // LCD memory bit segment
	LCDDR02_SEG023 = 0x80 // LCD memory bit segment

	// LCDDR01: LCD Data Register 1
	LCDDR01_SEG008 = 0x1  // LCD memory bit segment
	LCDDR01_SEG009 = 0x2  // LCD memory bit segment
	LCDDR01_SEG010 = 0x4  // LCD memory bit segment
	LCDDR01_SEG011 = 0x8  // LCD memory bit segment
	LCDDR01_SEG012 = 0x10 // LCD memory bit segment
	LCDDR01_SEG013 = 0x20 // LCD memory bit segment
	LCDDR01_SEG014 = 0x40 // LCD memory bit segment
	LCDDR01_SEG015 = 0x80 // LCD memory bit segment

	// LCDDR00: LCD Data Register 0
	LCDDR00_SEG000 = 0x1  // LCD memory bit segment
	LCDDR00_SEG001 = 0x2  // LCD memory bit segment
	LCDDR00_SEG002 = 0x4  // LCD memory bit segment
	LCDDR00_SEG003 = 0x8  // LCD memory bit segment
	LCDDR00_SEG004 = 0x10 // LCD memory bit segment
	LCDDR00_SEG005 = 0x20 // LCD memory bit segment
	LCDDR00_SEG006 = 0x40 // LCD memory bit segment
	LCDDR00_SEG007 = 0x80 // LCD memory bit segment

	// LCDCCR: LCD Contrast Control Register
	LCDCCR_LCDDC0 = 0x20 // LCD Display Configuration
	LCDCCR_LCDDC1 = 0x40 // LCD Display Configuration
	LCDCCR_LCDDC2 = 0x80 // LCD Display Configuration
	LCDCCR_LCDMDT = 0x10 // LCD Maximum Drive Time
	LCDCCR_LCDCC0 = 0x1  // LCD Contrast Controls
	LCDCCR_LCDCC1 = 0x2  // LCD Contrast Controls
	LCDCCR_LCDCC2 = 0x4  // LCD Contrast Controls
	LCDCCR_LCDCC3 = 0x8  // LCD Contrast Controls
...
const (
	...
	PCMSK1_PCINT0 = 0x1  // Pin Change Mask
	PCMSK1_PCINT1 = 0x2  // Pin Change Mask
	PCMSK1_PCINT2 = 0x4  // Pin Change Mask
	PCMSK1_PCINT3 = 0x8  // Pin Change Mask
	PCMSK1_PCINT4 = 0x10 // Pin Change Mask
	PCMSK1_PCINT5 = 0x20 // Pin Change Mask
	PCMSK1_PCINT6 = 0x40 // Pin Change Mask
	PCMSK1_PCINT7 = 0x80 // Pin Change Mask

	// PCMSK0: Pin Change Mask Register 0
	PCMSK0_PCINT0 = 0x1  // Pin Change Mask
	PCMSK0_PCINT1 = 0x2  // Pin Change Mask
	PCMSK0_PCINT2 = 0x4  // Pin Change Mask
	PCMSK0_PCINT3 = 0x8  // Pin Change Mask
	PCMSK0_PCINT4 = 0x10 // Pin Change Mask
	PCMSK0_PCINT5 = 0x20 // Pin Change Mask
	PCMSK0_PCINT6 = 0x40 // Pin Change Mask
	PCMSK0_PCINT7 = 0x80 // Pin Change Mask
)
