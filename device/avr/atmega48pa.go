...
// Generated by gen-device-avr.go from ATmega48PA.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega48pa
// +build avr,atmega48pa

// Device information for the ATmega48PA.
package avr
