...
// Generated by gen-device-avr.go from ATmega644A.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega644a
// +build avr,atmega644a

// Device information for the ATmega644A.
package avr
