...
// Generated by gen-device-avr.go from ATmega644PA.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega644pa
// +build avr,atmega644pa

// Device information for the ATmega644PA.
package avr
