...
// Generated by gen-device-avr.go from ATmega6450A.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega6450a
// +build avr,atmega6450a

// Device information for the ATmega6450A.
package avr
