...
// Generated by gen-device-avr.go from ATmega645P.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega645p
// +build avr,atmega645p

// Device information for the ATmega645P.
package avr
