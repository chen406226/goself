...
// Generated by gen-device-avr.go from ATmega649A.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega649a
// +build avr,atmega649a

// Device information for the ATmega649A.
package avr
