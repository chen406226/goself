...
// Generated by gen-device-avr.go from ATmega649P.atdf, see http://packs.download.atmel.com/

//go:build avr && atmega649p
// +build avr,atmega649p

// Device information for the ATmega649P.
package avr
