...
//go:build avr && atmega64a
// +build avr,atmega64a

// Device information for the ATmega64A.
package avr
...
var (
	...
	ADCSRB = (*volatile.Register8)(unsafe.Pointer(uintptr(0x8e)))
...
const (
	// EXTENDED
	EXTENDED_CompMode = 0x2 // ATmega103 Compatibility Mode
...
const (
	...
	XDIV_XDIV0  = 0x1  // XTAl Divide Select Bits
	XDIV_XDIV1  = 0x2  // XTAl Divide Select Bits
	XDIV_XDIV2  = 0x4  // XTAl Divide Select Bits
	XDIV_XDIV3  = 0x8  // XTAl Divide Select Bits
	XDIV_XDIV4  = 0x10 // XTAl Divide Select Bits
	XDIV_XDIV5  = 0x20 // XTAl Divide Select Bits
	XDIV_XDIV6  = 0x40 // XTAl Divide Select Bits
)
