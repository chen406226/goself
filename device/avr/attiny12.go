...
// Generated by gen-device-avr.go from ATtiny12.atdf, see http://packs.download.atmel.com/

//go:build avr && attiny12
// +build avr,attiny12

// Device information for the ATtiny12.
package avr
...
const (
	...
	IRQ_max        = 5 // Highest interrupt number on this device.
)
...
const (
	...
	ACSR_AINBG = 0x40 // Analog Comparator Bandgap Select
