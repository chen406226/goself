...
// Generated by gen-device-avr.go from ATtiny2313.atdf, see http://packs.download.atmel.com/

//go:build avr && attiny2313
// +build avr,attiny2313

// Device information for the ATtiny2313.
package avr
...
var (
	...
	EIFR  = (*volatile.Register8)(unsafe.Pointer(uintptr(0x5a)))
	...
	PCMSK  = (*volatile.Register8)(unsafe.Pointer(uintptr(0x40)))
...
const (
	...
	EIFR_INTF0 = 0x40 // External Interrupt Flags
	EIFR_INTF1 = 0x80 // External Interrupt Flags
	EIFR_PCIF  = 0x20
)
