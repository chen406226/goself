...
// Generated by gen-device-avr.go from ATtiny261A.atdf, see http://packs.download.atmel.com/

//go:build avr && attiny261a
// +build avr,attiny261a

// Device information for the ATtiny261A.
package avr
