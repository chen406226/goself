...
// Generated by gen-device-avr.go from ATtiny861A.atdf, see http://packs.download.atmel.com/

//go:build avr && attiny861a
// +build avr,attiny861a

// Device information for the ATtiny861A.
package avr
