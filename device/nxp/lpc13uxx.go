...
//export RIT_IRQ_IRQHandler
func interruptRIT_IRQ() {
	callHandlers(IRQ_RIT_IRQ)
}
...
var (
	...
	// Repetitive Interrupt Timer (RI timer)
	RITIMER = (*RITIMER_Type)(unsafe.Pointer(uintptr(0x40064000)))
...
type SYSCON_Type struct {
	...
	_             [444]byte
	DEVICE_ID     volatile.Register32 // 0x3F8
}
...
type RITIMER_Type struct {
	...
	COUNTER_H volatile.Register32 // 0x18
}
...
type GPIO_PORT_Type struct {
	B     [64]volatile.Register8 // 0x0
	_     [4032]byte
	W     [64]volatile.Register32 // 0x1000
	_     [3840]byte
...
const (
	...
	USART_SYNCCTRL_SSDIS_SEND_START_STOP = 0x0
	// Do not send start/stop bits.
	USART_SYNCCTRL_SSDIS_NOT_SEND_START_STOP = 0x1
...
const (
	...
	// Software-controlled mode: Conversions are software-controlled and require 31 clocks.
	...
	// Bit mask of RESERVED field.
	ADC_CR_RESERVED_Msk = 0x200000
	// Bit RESERVED.
	ADC_CR_RESERVED = 0x200000
	// Position of LPWRMODE field.
	ADC_CR_LPWRMODE_Pos = 0x16
	// Bit mask of LPWRMODE field.
	ADC_CR_LPWRMODE_Msk = 0x400000
	// Bit LPWRMODE.
	ADC_CR_LPWRMODE = 0x400000
	// Disable the low-power ADC mode. The analog circuitry remains activated when no conversions are requested.
	ADC_CR_LPWRMODE_DISABLE_THE_LOW_POWE = 0x0
	...
	ADC_CR_LPWRMODE_ENABLE_THE_LOW_POWER = 0x1
	// Position of MODE10BIT field.
	ADC_CR_MODE10BIT_Pos = 0x17
	// Bit mask of MODE10BIT field.
	ADC_CR_MODE10BIT_Msk = 0x800000
	// Bit MODE10BIT.
	ADC_CR_MODE10BIT = 0x800000
	// Disable the 10-bit conversion rate mode.
	ADC_CR_MODE10BIT_DISABLE_THE_10_BIT_C = 0x0
	...
	ADC_CR_MODE10BIT_ENABLE_THE_10_BIT_CO = 0x1
	// Position of START field.
	...
	ADC_GDR_V_VREF_Pos = 0x4
	// Bit mask of V_VREF field.
	ADC_GDR_V_VREF_Msk = 0xfff0
	// Position of RESERVED field.
	...
	// DR: A/D Channel N Data Register. This register contains the result of the most recent conversion completed on channel n
	// Position of RESERVED field.
	ADC_DR_RESERVED_Pos = 0x0
	// Bit mask of RESERVED field.
	ADC_DR_RESERVED_Msk = 0xf
	// Position of V_VREF field.
	ADC_DR_V_VREF_Pos = 0x4
	// Bit mask of V_VREF field.
	ADC_DR_V_VREF_Msk = 0xfff0
	// Position of RESERVED field.
...
// Bitfields for IOCON: IO ocnfiguration
const (
	...
	// PIO0_8: I/O configuration for pin PIO0_8/MISO0/CT16B0_MAT0/ ARM_TRACE_CLK
	// Position of FUNC field.
	...
	// ARM_TRACE_CLK
	IOCON_PIO0_8_FUNC_ARM_TRACE_CLK = 0x3
	// Position of MODE field.
	...
	// PIO0_9: I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1/ ARM_TRACE_SWV
	// Position of FUNC field.
	...
	// ARM_TRACE_SWV
	IOCON_PIO0_9_FUNC_ARM_TRACE_SWV = 0x3
	// Position of MODE field.
	...
	// PIO1_13: I/O configuration for PIO1_13/DTR/CT16B0_MAT0/TXD
	// Position of FUNC field.
	IOCON_PIO1_13_FUNC_Pos = 0x0
	// Bit mask of FUNC field.
	IOCON_PIO1_13_FUNC_Msk = 0x7
	// PIO1_13
	IOCON_PIO1_13_FUNC_PIO1_13 = 0x0
	// DTR
	IOCON_PIO1_13_FUNC_DTR = 0x1
	// CT16B0_MAT0
	IOCON_PIO1_13_FUNC_CT16B0_MAT0 = 0x2
	// TXD
	IOCON_PIO1_13_FUNC_TXD = 0x3
	// Position of MODE field.
	...
	// PIO1_14: I/O configuration for PIO1_14/DSR/CT16B0_MAT1/RXD
	// Position of FUNC field.
	...
	// DSR
	IOCON_PIO1_14_FUNC_DSR = 0x1
	// CT16B0_MAT1
	IOCON_PIO1_14_FUNC_CT16B0_MAT1 = 0x2
	// RXD
	IOCON_PIO1_14_FUNC_RXD = 0x3
	// Position of MODE field.
...
const (
	...
	// Resets the SSP0 peripheral.
	SYSCON_PRESETCTRL_SSP1_RST_N_RESETS_THE_SSP0_PERI = 0x0
	...
	// Reserved.
	SYSCON_BODCTRL_BODINTVAL_RESERVED_ = 0x0
	...
	// PINTSEL0: GPIO Pin Interrupt Select register
	...
	SYSCON_PINTSEL_PORTSEL_Pos = 0x5
	// Bit mask of PORTSEL field.
	SYSCON_PINTSEL_PORTSEL_Msk = 0x20
	// Bit PORTSEL.
	SYSCON_PINTSEL_PORTSEL = 0x20
	// Port 0
	SYSCON_PINTSEL_PORTSEL_PORT_0 = 0x0
	// Port 1
	SYSCON_PINTSEL_PORTSEL_PORT_1 = 0x1
	// Position of RESERVED field.
	...
	// Bit mask of RESERVED field.
	SYSCON_PDAWAKECFG_RESERVED_Msk = 0xffffe000
...
// Bitfields for RITIMER: Repetitive Interrupt Timer (RI timer)
const (
	...
	// MASK: Mask LSB register. This register holds the 32 LSB s of the mask value. A one written to any bit will force a compare on the corresponding bit of the counter and compare register.
	...
	RITIMER_CTRL_RITINT_MASK = 0x1
	// The counter value does not equal the masked compare value.
	RITIMER_CTRL_RITINT_NO_MASK = 0x0
	...
	RITIMER_CTRL_RITENCLR_CLEAR_ON_O = 0x1
	// The timer will not be cleared to 0.
	RITIMER_CTRL_RITENCLR_NOT_CLEAR_ON_0 = 0x0
	...
	RITIMER_CTRL_RITENBR_HALT_ON_DEBUG = 0x1
	// Debug has no effect on the timer operation.
	RITIMER_CTRL_RITENBR_NO_EFFECT_ON_DEBUG = 0x0
	...
	RITIMER_CTRL_RITEN_TIMER_ENABLED = 0x1
	// Timer disabled.
	...
	// Position of RICOMP field.
	RITIMER_COMPVAL_H_RICOMP_Pos = 0x0
	// Bit mask of RICOMP field.
	RITIMER_COMPVAL_H_RICOMP_Msk = 0xffff
	// Position of RESERVED field.
	RITIMER_COMPVAL_H_RESERVED_Pos = 0x10
	// Bit mask of RESERVED field.
	RITIMER_COMPVAL_H_RESERVED_Msk = 0xffff0000

	// MASK_H: Mask MSB register. This register holds the 16 MSBs of the mask value. A one written to any bit will force a compare on the corresponding bit of the counter and compare register.
	// Position of RIMASK field.
	RITIMER_MASK_H_RIMASK_Pos = 0x0
	// Bit mask of RIMASK field.
	RITIMER_MASK_H_RIMASK_Msk = 0xffff
	// Position of RESERVED field.
	RITIMER_MASK_H_RESERVED_Pos = 0x10
	// Bit mask of RESERVED field.
	RITIMER_MASK_H_RESERVED_Msk = 0xffff0000

	// COUNTER_H: Counter MSB register. 16 MSBs of the counter.
	// Position of RICOUNTER field.
	RITIMER_COUNTER_H_RICOUNTER_Pos = 0x0
	// Bit mask of RICOUNTER field.
	RITIMER_COUNTER_H_RICOUNTER_Msk = 0xffff
	// Position of RESERVED field.
	RITIMER_COUNTER_H_RESERVED_Pos = 0x10
	// Bit mask of RESERVED field.
	RITIMER_COUNTER_H_RESERVED_Msk = 0xffff0000
)
...
const (
	// B: Byte pin registers port 0/1; pins PIO0/1_0 to PIO0/1_31
