...
//go:build sam && atsam4sp32a
// +build sam,atsam4sp32a
...
//export PPLC_IRQHandler
func interruptPPLC() {
	callHandlers(IRQ_PPLC)
}
...
var (
	...
	// PRIME Power Line Communication (PPLC) Transceiver
	PPLC = (*PPLC_Type)(unsafe.Pointer(uintptr(0x40008000)))
...
type ADC_Type struct {
	...
	CDR   [10]volatile.Register32 // 0x50
	_     [28]byte
...
// Bitfields for PPLC: PRIME Power Line Communication (PPLC) Transceiver
const (
	// CR: Control Register
	// Position of PPLCEN field.
	PPLC_CR_PPLCEN_Pos = 0x0
	// Bit mask of PPLCEN field.
	PPLC_CR_PPLCEN_Msk = 0x1
	// Bit PPLCEN.
	PPLC_CR_PPLCEN = 0x1
	// Position of PPLCDIS field.
	PPLC_CR_PPLCDIS_Pos = 0x1
	// Bit mask of PPLCDIS field.
	PPLC_CR_PPLCDIS_Msk = 0x2
	// Bit PPLCDIS.
	PPLC_CR_PPLCDIS = 0x2
	// Position of SWRST field.
	PPLC_CR_SWRST_Pos = 0x7
	// Bit mask of SWRST field.
	PPLC_CR_SWRST_Msk = 0x80
	// Bit SWRST.
	PPLC_CR_SWRST = 0x80
	// Position of LASTXFER field.
	PPLC_CR_LASTXFER_Pos = 0x18
	// Bit mask of LASTXFER field.
	PPLC_CR_LASTXFER_Msk = 0x1000000
	// Bit LASTXFER.
	PPLC_CR_LASTXFER = 0x1000000

	// MR: Mode Register
	// Position of MSTR field.
	PPLC_MR_MSTR_Pos = 0x0
	// Bit mask of MSTR field.
	PPLC_MR_MSTR_Msk = 0x1
	// Bit MSTR.
	PPLC_MR_MSTR = 0x1
	...
	PPLC_MR_PCSDEC_Pos = 0x2
	// Bit mask of PCSDEC field.
	PPLC_MR_PCSDEC_Msk = 0x4
	// Bit PCSDEC.
	PPLC_MR_PCSDEC = 0x4
	// Position of MODFDIS field.
	PPLC_MR_MODFDIS_Pos = 0x4
	// Bit mask of MODFDIS field.
	PPLC_MR_MODFDIS_Msk = 0x10
	// Bit MODFDIS.
	PPLC_MR_MODFDIS = 0x10
	// Position of WDRBT field.
	PPLC_MR_WDRBT_Pos = 0x5
	// Bit mask of WDRBT field.
	PPLC_MR_WDRBT_Msk = 0x20
	// Bit WDRBT.
	PPLC_MR_WDRBT = 0x20
	// Position of LLB field.
	PPLC_MR_LLB_Pos = 0x7
	// Bit mask of LLB field.
	PPLC_MR_LLB_Msk = 0x80
	// Bit LLB.
	PPLC_MR_LLB = 0x80
	// Position of PCS field.
	PPLC_MR_PCS_Pos = 0x10
	// Bit mask of PCS field.
	PPLC_MR_PCS_Msk = 0xf0000
	// Position of DLYBCS field.
	PPLC_MR_DLYBCS_Pos = 0x18
	// Bit mask of DLYBCS field.
	PPLC_MR_DLYBCS_Msk = 0xff000000

	// RDR: Receive Data Register
	// Position of RD field.
	PPLC_RDR_RD_Pos = 0x0
	// Bit mask of RD field.
	PPLC_RDR_RD_Msk = 0xffff
	// Position of PCS field.
	PPLC_RDR_PCS_Pos = 0x10
	// Bit mask of PCS field.
	PPLC_RDR_PCS_Msk = 0xf0000

	// TDR: Transmit Data Register
	// Position of TD field.
	PPLC_TDR_TD_Pos = 0x0
	// Bit mask of TD field.
	PPLC_TDR_TD_Msk = 0xffff
	// Position of PCS field.
	PPLC_TDR_PCS_Pos = 0x10
	// Bit mask of PCS field.
	PPLC_TDR_PCS_Msk = 0xf0000
	// Position of LASTXFER field.
	PPLC_TDR_LASTXFER_Pos = 0x18
	// Bit mask of LASTXFER field.
	PPLC_TDR_LASTXFER_Msk = 0x1000000
	// Bit LASTXFER.
	PPLC_TDR_LASTXFER = 0x1000000

	// SR: Status Register
	// Position of RDRF field.
	PPLC_SR_RDRF_Pos = 0x0
	// Bit mask of RDRF field.
	PPLC_SR_RDRF_Msk = 0x1
	// Bit RDRF.
	PPLC_SR_RDRF = 0x1
	// Position of TDRE field.
	PPLC_SR_TDRE_Pos = 0x1
	// Bit mask of TDRE field.
	PPLC_SR_TDRE_Msk = 0x2
	// Bit TDRE.
	PPLC_SR_TDRE = 0x2
	// Position of MODF field.
	PPLC_SR_MODF_Pos = 0x2
	// Bit mask of MODF field.
	PPLC_SR_MODF_Msk = 0x4
	// Bit MODF.
	PPLC_SR_MODF = 0x4
	// Position of OVRES field.
	PPLC_SR_OVRES_Pos = 0x3
	// Bit mask of OVRES field.
	PPLC_SR_OVRES_Msk = 0x8
	// Bit OVRES.
	PPLC_SR_OVRES = 0x8
	// Position of ENDRX field.
	PPLC_SR_ENDRX_Pos = 0x4
	// Bit mask of ENDRX field.
	PPLC_SR_ENDRX_Msk = 0x10
	// Bit ENDRX.
	PPLC_SR_ENDRX = 0x10
	// Position of ENDTX field.
	PPLC_SR_ENDTX_Pos = 0x5
	// Bit mask of ENDTX field.
	PPLC_SR_ENDTX_Msk = 0x20
	// Bit ENDTX.
	PPLC_SR_ENDTX = 0x20
	// Position of RXBUFF field.
	PPLC_SR_RXBUFF_Pos = 0x6
	// Bit mask of RXBUFF field.
	PPLC_SR_RXBUFF_Msk = 0x40
	// Bit RXBUFF.
	PPLC_SR_RXBUFF = 0x40
	// Position of TXBUFE field.
	PPLC_SR_TXBUFE_Pos = 0x7
	// Bit mask of TXBUFE field.
	PPLC_SR_TXBUFE_Msk = 0x80
	// Bit TXBUFE.
	PPLC_SR_TXBUFE = 0x80
	// Position of NSSR field.
	PPLC_SR_NSSR_Pos = 0x8
	// Bit mask of NSSR field.
	PPLC_SR_NSSR_Msk = 0x100
	// Bit NSSR.
	PPLC_SR_NSSR = 0x100
	// Position of TXEMPTY field.
	PPLC_SR_TXEMPTY_Pos = 0x9
	// Bit mask of TXEMPTY field.
	PPLC_SR_TXEMPTY_Msk = 0x200
	// Bit TXEMPTY.
	PPLC_SR_TXEMPTY = 0x200
	// Position of UNDES field.
	PPLC_SR_UNDES_Pos = 0xa
	// Bit mask of UNDES field.
	PPLC_SR_UNDES_Msk = 0x400
	// Bit UNDES.
	PPLC_SR_UNDES = 0x400
	// Position of PPLCENS field.
	PPLC_SR_PPLCENS_Pos = 0x10
	// Bit mask of PPLCENS field.
	PPLC_SR_PPLCENS_Msk = 0x10000
	// Bit PPLCENS.
	PPLC_SR_PPLCENS = 0x10000

	// IER: Interrupt Enable Register
	// Position of RDRF field.
	PPLC_IER_RDRF_Pos = 0x0
	// Bit mask of RDRF field.
	PPLC_IER_RDRF_Msk = 0x1
	// Bit RDRF.
	PPLC_IER_RDRF = 0x1
	// Position of TDRE field.
	PPLC_IER_TDRE_Pos = 0x1
	// Bit mask of TDRE field.
	PPLC_IER_TDRE_Msk = 0x2
	// Bit TDRE.
	PPLC_IER_TDRE = 0x2
	// Position of MODF field.
	PPLC_IER_MODF_Pos = 0x2
	// Bit mask of MODF field.
	PPLC_IER_MODF_Msk = 0x4
	// Bit MODF.
	PPLC_IER_MODF = 0x4
	// Position of OVRES field.
	PPLC_IER_OVRES_Pos = 0x3
	// Bit mask of OVRES field.
	PPLC_IER_OVRES_Msk = 0x8
	// Bit OVRES.
	PPLC_IER_OVRES = 0x8
	// Position of ENDRX field.
	PPLC_IER_ENDRX_Pos = 0x4
	// Bit mask of ENDRX field.
	PPLC_IER_ENDRX_Msk = 0x10
	// Bit ENDRX.
	PPLC_IER_ENDRX = 0x10
	// Position of ENDTX field.
	PPLC_IER_ENDTX_Pos = 0x5
	// Bit mask of ENDTX field.
	PPLC_IER_ENDTX_Msk = 0x20
	// Bit ENDTX.
	PPLC_IER_ENDTX = 0x20
	// Position of RXBUFF field.
	PPLC_IER_RXBUFF_Pos = 0x6
	// Bit mask of RXBUFF field.
	PPLC_IER_RXBUFF_Msk = 0x40
	// Bit RXBUFF.
	PPLC_IER_RXBUFF = 0x40
	// Position of TXBUFE field.
	PPLC_IER_TXBUFE_Pos = 0x7
	// Bit mask of TXBUFE field.
	PPLC_IER_TXBUFE_Msk = 0x80
	// Bit TXBUFE.
	PPLC_IER_TXBUFE = 0x80
	// Position of NSSR field.
	PPLC_IER_NSSR_Pos = 0x8
	// Bit mask of NSSR field.
	PPLC_IER_NSSR_Msk = 0x100
	// Bit NSSR.
	PPLC_IER_NSSR = 0x100
	// Position of TXEMPTY field.
	PPLC_IER_TXEMPTY_Pos = 0x9
	// Bit mask of TXEMPTY field.
	PPLC_IER_TXEMPTY_Msk = 0x200
	// Bit TXEMPTY.
	PPLC_IER_TXEMPTY = 0x200
	// Position of UNDES field.
	PPLC_IER_UNDES_Pos = 0xa
	// Bit mask of UNDES field.
	PPLC_IER_UNDES_Msk = 0x400
	// Bit UNDES.
	PPLC_IER_UNDES = 0x400

	// IDR: Interrupt Disable Register
	// Position of RDRF field.
	PPLC_IDR_RDRF_Pos = 0x0
	// Bit mask of RDRF field.
	PPLC_IDR_RDRF_Msk = 0x1
	// Bit RDRF.
	PPLC_IDR_RDRF = 0x1
	// Position of TDRE field.
	PPLC_IDR_TDRE_Pos = 0x1
	// Bit mask of TDRE field.
	PPLC_IDR_TDRE_Msk = 0x2
	// Bit TDRE.
	PPLC_IDR_TDRE = 0x2
	// Position of MODF field.
	PPLC_IDR_MODF_Pos = 0x2
	// Bit mask of MODF field.
	PPLC_IDR_MODF_Msk = 0x4
	// Bit MODF.
	PPLC_IDR_MODF = 0x4
	// Position of OVRES field.
	PPLC_IDR_OVRES_Pos = 0x3
	// Bit mask of OVRES field.
	PPLC_IDR_OVRES_Msk = 0x8
	// Bit OVRES.
	PPLC_IDR_OVRES = 0x8
	// Position of ENDRX field.
	PPLC_IDR_ENDRX_Pos = 0x4
	// Bit mask of ENDRX field.
	PPLC_IDR_ENDRX_Msk = 0x10
	// Bit ENDRX.
	PPLC_IDR_ENDRX = 0x10
	// Position of ENDTX field.
	PPLC_IDR_ENDTX_Pos = 0x5
	// Bit mask of ENDTX field.
	PPLC_IDR_ENDTX_Msk = 0x20
	// Bit ENDTX.
	PPLC_IDR_ENDTX = 0x20
	// Position of RXBUFF field.
	PPLC_IDR_RXBUFF_Pos = 0x6
	// Bit mask of RXBUFF field.
	PPLC_IDR_RXBUFF_Msk = 0x40
	// Bit RXBUFF.
	PPLC_IDR_RXBUFF = 0x40
	// Position of TXBUFE field.
	PPLC_IDR_TXBUFE_Pos = 0x7
	// Bit mask of TXBUFE field.
	PPLC_IDR_TXBUFE_Msk = 0x80
	// Bit TXBUFE.
	PPLC_IDR_TXBUFE = 0x80
	// Position of NSSR field.
	PPLC_IDR_NSSR_Pos = 0x8
	// Bit mask of NSSR field.
	PPLC_IDR_NSSR_Msk = 0x100
	// Bit NSSR.
	PPLC_IDR_NSSR = 0x100
	// Position of TXEMPTY field.
	PPLC_IDR_TXEMPTY_Pos = 0x9
	// Bit mask of TXEMPTY field.
	PPLC_IDR_TXEMPTY_Msk = 0x200
	// Bit TXEMPTY.
	PPLC_IDR_TXEMPTY = 0x200
	// Position of UNDES field.
	PPLC_IDR_UNDES_Pos = 0xa
	// Bit mask of UNDES field.
	PPLC_IDR_UNDES_Msk = 0x400
	// Bit UNDES.
	PPLC_IDR_UNDES = 0x400

	// IMR: Interrupt Mask Register
	// Position of RDRF field.
	PPLC_IMR_RDRF_Pos = 0x0
	// Bit mask of RDRF field.
	PPLC_IMR_RDRF_Msk = 0x1
	// Bit RDRF.
	PPLC_IMR_RDRF = 0x1
	// Position of TDRE field.
	PPLC_IMR_TDRE_Pos = 0x1
	// Bit mask of TDRE field.
	PPLC_IMR_TDRE_Msk = 0x2
	// Bit TDRE.
	PPLC_IMR_TDRE = 0x2
	// Position of MODF field.
	PPLC_IMR_MODF_Pos = 0x2
	// Bit mask of MODF field.
	PPLC_IMR_MODF_Msk = 0x4
	// Bit MODF.
	PPLC_IMR_MODF = 0x4
	// Position of OVRES field.
	PPLC_IMR_OVRES_Pos = 0x3
	// Bit mask of OVRES field.
	PPLC_IMR_OVRES_Msk = 0x8
	// Bit OVRES.
	PPLC_IMR_OVRES = 0x8
	// Position of ENDRX field.
	PPLC_IMR_ENDRX_Pos = 0x4
	// Bit mask of ENDRX field.
	PPLC_IMR_ENDRX_Msk = 0x10
	// Bit ENDRX.
	PPLC_IMR_ENDRX = 0x10
	// Position of ENDTX field.
	PPLC_IMR_ENDTX_Pos = 0x5
	// Bit mask of ENDTX field.
	PPLC_IMR_ENDTX_Msk = 0x20
	// Bit ENDTX.
	PPLC_IMR_ENDTX = 0x20
	// Position of RXBUFF field.
	PPLC_IMR_RXBUFF_Pos = 0x6
	// Bit mask of RXBUFF field.
	PPLC_IMR_RXBUFF_Msk = 0x40
	// Bit RXBUFF.
	PPLC_IMR_RXBUFF = 0x40
	// Position of TXBUFE field.
	PPLC_IMR_TXBUFE_Pos = 0x7
	// Bit mask of TXBUFE field.
	PPLC_IMR_TXBUFE_Msk = 0x80
	// Bit TXBUFE.
	PPLC_IMR_TXBUFE = 0x80
	// Position of NSSR field.
	PPLC_IMR_NSSR_Pos = 0x8
	// Bit mask of NSSR field.
	PPLC_IMR_NSSR_Msk = 0x100
	// Bit NSSR.
	PPLC_IMR_NSSR = 0x100
	// Position of TXEMPTY field.
	PPLC_IMR_TXEMPTY_Pos = 0x9
	// Bit mask of TXEMPTY field.
	PPLC_IMR_TXEMPTY_Msk = 0x200
	// Bit TXEMPTY.
	PPLC_IMR_TXEMPTY = 0x200
	// Position of UNDES field.
	PPLC_IMR_UNDES_Pos = 0xa
	// Bit mask of UNDES field.
	PPLC_IMR_UNDES_Msk = 0x400
	// Bit UNDES.
	PPLC_IMR_UNDES = 0x400

	// CSR: Chip Select Register
	// Position of CPOL field.
	PPLC_CSR_CPOL_Pos = 0x0
	// Bit mask of CPOL field.
	PPLC_CSR_CPOL_Msk = 0x1
	// Bit CPOL.
	PPLC_CSR_CPOL = 0x1
	// Position of NCPHA field.
	PPLC_CSR_NCPHA_Pos = 0x1
	// Bit mask of NCPHA field.
	PPLC_CSR_NCPHA_Msk = 0x2
	// Bit NCPHA.
	PPLC_CSR_NCPHA = 0x2
	// Position of CSNAAT field.
	PPLC_CSR_CSNAAT_Pos = 0x2
	// Bit mask of CSNAAT field.
	PPLC_CSR_CSNAAT_Msk = 0x4
	// Bit CSNAAT.
	PPLC_CSR_CSNAAT = 0x4
	// Position of CSAAT field.
	PPLC_CSR_CSAAT_Pos = 0x3
	// Bit mask of CSAAT field.
	PPLC_CSR_CSAAT_Msk = 0x8
	// Bit CSAAT.
	PPLC_CSR_CSAAT = 0x8
	// Position of BITS field.
	PPLC_CSR_BITS_Pos = 0x4
	// Bit mask of BITS field.
	PPLC_CSR_BITS_Msk = 0xf0
	// Position of SCBR field.
	PPLC_CSR_SCBR_Pos = 0x8
	// Bit mask of SCBR field.
	PPLC_CSR_SCBR_Msk = 0xff00
	// Position of DLYBS field.
	PPLC_CSR_DLYBS_Pos = 0x10
	// Bit mask of DLYBS field.
	PPLC_CSR_DLYBS_Msk = 0xff0000
	// Position of DLYBCT field.
	PPLC_CSR_DLYBCT_Pos = 0x18
	// Bit mask of DLYBCT field.
	PPLC_CSR_DLYBCT_Msk = 0xff000000

	// WPMR: Write Protection Control Register
	// Position of WPEN field.
	PPLC_WPMR_WPEN_Pos = 0x0
	// Bit mask of WPEN field.
	PPLC_WPMR_WPEN_Msk = 0x1
	// Bit WPEN.
	PPLC_WPMR_WPEN = 0x1
	// Position of WPKEY field.
	PPLC_WPMR_WPKEY_Pos = 0x8
	// Bit mask of WPKEY field.
	PPLC_WPMR_WPKEY_Msk = 0xffffff00

	// WPSR: Write Protection Status Register
	// Position of WPVS field.
	PPLC_WPSR_WPVS_Pos = 0x0
	// Bit mask of WPVS field.
	PPLC_WPSR_WPVS_Msk = 0x1
	// Bit WPVS.
	PPLC_WPSR_WPVS = 0x1
	// Position of WPVSRC field.
	PPLC_WPSR_WPVSRC_Pos = 0x8
	// Bit mask of WPVSRC field.
	PPLC_WPSR_WPVSRC_Msk = 0xff00

	// RPR: Receive Pointer Register
	// Position of RXPTR field.
	PPLC_RPR_RXPTR_Pos = 0x0
	// Bit mask of RXPTR field.
	PPLC_RPR_RXPTR_Msk = 0xffffffff

	// RCR: Receive Counter Register
	// Position of RXCTR field.
	PPLC_RCR_RXCTR_Pos = 0x0
	// Bit mask of RXCTR field.
	PPLC_RCR_RXCTR_Msk = 0xffff

	// TPR: Transmit Pointer Register
	// Position of TXPTR field.
	PPLC_TPR_TXPTR_Pos = 0x0
	// Bit mask of TXPTR field.
	PPLC_TPR_TXPTR_Msk = 0xffffffff

	// TCR: Transmit Counter Register
	// Position of TXCTR field.
	PPLC_TCR_TXCTR_Pos = 0x0
	// Bit mask of TXCTR field.
	PPLC_TCR_TXCTR_Msk = 0xffff

	// RNPR: Receive Next Pointer Register
	// Position of RXNPTR field.
	PPLC_RNPR_RXNPTR_Pos = 0x0
	// Bit mask of RXNPTR field.
	PPLC_RNPR_RXNPTR_Msk = 0xffffffff

	// RNCR: Receive Next Counter Register
	// Position of RXNCTR field.
	PPLC_RNCR_RXNCTR_Pos = 0x0
	// Bit mask of RXNCTR field.
	PPLC_RNCR_RXNCTR_Msk = 0xffff

	// TNPR: Transmit Next Pointer Register
	// Position of TXNPTR field.
	PPLC_TNPR_TXNPTR_Pos = 0x0
	// Bit mask of TXNPTR field.
	PPLC_TNPR_TXNPTR_Msk = 0xffffffff

	// TNCR: Transmit Next Counter Register
	// Position of TXNCTR field.
	PPLC_TNCR_TXNCTR_Pos = 0x0
	// Bit mask of TXNCTR field.
	PPLC_TNCR_TXNCTR_Msk = 0xffff

	// PTCR: Transfer Control Register
	// Position of RXTEN field.
	PPLC_PTCR_RXTEN_Pos = 0x0
	// Bit mask of RXTEN field.
	PPLC_PTCR_RXTEN_Msk = 0x1
	// Bit RXTEN.
	PPLC_PTCR_RXTEN = 0x1
	// Position of RXTDIS field.
	PPLC_PTCR_RXTDIS_Pos = 0x1
	// Bit mask of RXTDIS field.
	PPLC_PTCR_RXTDIS_Msk = 0x2
	// Bit RXTDIS.
	PPLC_PTCR_RXTDIS = 0x2
	// Position of TXTEN field.
	PPLC_PTCR_TXTEN_Pos = 0x8
	// Bit mask of TXTEN field.
	PPLC_PTCR_TXTEN_Msk = 0x100
	// Bit TXTEN.
	PPLC_PTCR_TXTEN = 0x100
	// Position of TXTDIS field.
	PPLC_PTCR_TXTDIS_Pos = 0x9
	// Bit mask of TXTDIS field.
	PPLC_PTCR_TXTDIS_Msk = 0x200
	// Bit TXTDIS.
	PPLC_PTCR_TXTDIS = 0x200

	// PTSR: Transfer Status Register
	// Position of RXTEN field.
	PPLC_PTSR_RXTEN_Pos = 0x0
	// Bit mask of RXTEN field.
	PPLC_PTSR_RXTEN_Msk = 0x1
	// Bit RXTEN.
	PPLC_PTSR_RXTEN = 0x1
	// Position of TXTEN field.
	PPLC_PTSR_TXTEN_Pos = 0x8
	// Bit mask of TXTEN field.
	PPLC_PTSR_TXTEN_Msk = 0x100
	// Bit TXTEN.
	PPLC_PTSR_TXTEN = 0x100
)
...
// Bitfields for CMCC: Cortex M Cache Controller
const (
...
const (
	...
	CHIPID_CIDR_ARCH_SAM4MxxC = 0x65
	// AT91SAM7Sxx Series
