...
//go:build sam && atsamd21g17l
// +build sam,atsamd21g17l
...
//export SERCOM4_IRQHandler
func interruptSERCOM4() {
	callHandlers(IRQ_SERCOM4)
}

//export SERCOM5_IRQHandler
func interruptSERCOM5() {
	callHandlers(IRQ_SERCOM5)
}
...
//export AC1_IRQHandler
func interruptAC1() {
	callHandlers(IRQ_AC1)
}

//export TCC3_IRQHandler
func interruptTCC3() {
	callHandlers(IRQ_TCC3)
}
...
var (
	...
	// Analog Comparators 1
	AC1 = (*AC_Type)(unsafe.Pointer(uintptr(0x42005400)))
	...
	// Timer Counter Control 3
	TCC3 = (*TCC_Type)(unsafe.Pointer(uintptr(0x42006000)))
)
...
const (
	...
	// Position of AC1_ field.
	PM_APBCMASK_AC1__Pos = 0x15
	// Bit mask of AC1_ field.
	PM_APBCMASK_AC1__Msk = 0x200000
	// Bit AC1_.
	PM_APBCMASK_AC1_ = 0x200000
	// Position of TCC3_ field.
	PM_APBCMASK_TCC3__Pos = 0x18
	// Bit mask of TCC3_ field.
	PM_APBCMASK_TCC3__Msk = 0x1000000
	// Bit TCC3_.
	PM_APBCMASK_TCC3_ = 0x1000000
