...
// Generated by gen-device-svd.go from ATSAMD21J17A.svd, see https://github.com/posborne/cmsis-svd/tree/master/data/Atmel

//go:build sam && atsamd21j17a
// +build sam,atsamd21j17a

// Microchip ATSAMD21J17A device: Cortex-M0+ Microcontroller with 128KB Flash, 16KB SRAM, 64-pin package
//
...
type DSU_Type struct {
	...
	_       [4068]byte
	ENTRY   volatile.Register32 // 0x1000
