...
// Generated by gen-device-svd.go from ATSAMD51P19A.svd, see https://github.com/posborne/cmsis-svd/tree/master/data/Atmel

//go:build sam && atsamd51p19a
// +build sam,atsamd51p19a

// Microchip ATSAMD51P19A Microcontroller
//
