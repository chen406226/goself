...
// Generated by gen-device-svd.go from ATSAMD51P20A.svd, see https://github.com/posborne/cmsis-svd/tree/master/data/Atmel

//go:build sam && atsamd51p20a
// +build sam,atsamd51p20a

// Microchip ATSAMD51P20A Microcontroller
//
