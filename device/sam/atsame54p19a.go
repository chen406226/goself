...
// Generated by gen-device-svd.go from ATSAME54P19A.svd, see https://github.com/posborne/cmsis-svd/tree/master/data/Atmel

//go:build sam && atsame54p19a
// +build sam,atsame54p19a

// Microchip ATSAME54P19A Microcontroller
//
...
//export SERCOM6_0_IRQHandler
func interruptSERCOM6_0() {
	callHandlers(IRQ_SERCOM6_0)
}

//export SERCOM6_1_IRQHandler
func interruptSERCOM6_1() {
	callHandlers(IRQ_SERCOM6_1)
}

//export SERCOM6_2_IRQHandler
func interruptSERCOM6_2() {
	callHandlers(IRQ_SERCOM6_2)
}

//export SERCOM6_OTHER_IRQHandler
func interruptSERCOM6_OTHER() {
	callHandlers(IRQ_SERCOM6_OTHER)
}

//export SERCOM7_0_IRQHandler
func interruptSERCOM7_0() {
	callHandlers(IRQ_SERCOM7_0)
}

//export SERCOM7_1_IRQHandler
func interruptSERCOM7_1() {
	callHandlers(IRQ_SERCOM7_1)
}

//export SERCOM7_2_IRQHandler
func interruptSERCOM7_2() {
	callHandlers(IRQ_SERCOM7_2)
}

//export SERCOM7_OTHER_IRQHandler
func interruptSERCOM7_OTHER() {
...
//export SDHC1_IRQHandler
func interruptSDHC1() {
	callHandlers(IRQ_SDHC1)
}
...
var (
	...
	// Control Area Network
	CAN0 = (*CAN_Type)(unsafe.Pointer(uintptr(0x42000000)))
	...
	// Control Area Network
	CAN1 = (*CAN_Type)(unsafe.Pointer(uintptr(0x42000400)))

	// SD/MMC Host Controller
	SDHC1 = (*SDHC_Type)(unsafe.Pointer(uintptr(0x46000000)))
	...
	// Serial Communication Interface
	SERCOM6 = (*SERCOM_Type)(unsafe.Pointer(uintptr(0x43000800)))

	// Serial Communication Interface - I2CM
	SERCOM6_I2CM = (*SERCOM_I2CM_Type)(unsafe.Pointer(uintptr(0x43000800)))

	// Serial Communication Interface - I2CS
	SERCOM6_I2CS = (*SERCOM_I2CS_Type)(unsafe.Pointer(uintptr(0x43000800)))

	// Serial Communication Interface - SPIS
	SERCOM6_SPIS = (*SERCOM_SPIS_Type)(unsafe.Pointer(uintptr(0x43000800)))

	// Serial Communication Interface - SPIM
	SERCOM6_SPIM = (*SERCOM_SPIM_Type)(unsafe.Pointer(uintptr(0x43000800)))

	// Serial Communication Interface - USART_EXT
	SERCOM6_USART_EXT = (*SERCOM_USART_EXT_Type)(unsafe.Pointer(uintptr(0x43000800)))

	// Serial Communication Interface - USART_INT
	SERCOM6_USART_INT = (*SERCOM_USART_INT_Type)(unsafe.Pointer(uintptr(0x43000800)))

	// Serial Communication Interface
	SERCOM7 = (*SERCOM_Type)(unsafe.Pointer(uintptr(0x43000c00)))

	// Serial Communication Interface - I2CM
	SERCOM7_I2CM = (*SERCOM_I2CM_Type)(unsafe.Pointer(uintptr(0x43000c00)))

	// Serial Communication Interface - I2CS
	SERCOM7_I2CS = (*SERCOM_I2CS_Type)(unsafe.Pointer(uintptr(0x43000c00)))

	// Serial Communication Interface - SPIS
	SERCOM7_SPIS = (*SERCOM_SPIS_Type)(unsafe.Pointer(uintptr(0x43000c00)))

	// Serial Communication Interface - SPIM
	SERCOM7_SPIM = (*SERCOM_SPIM_Type)(unsafe.Pointer(uintptr(0x43000c00)))

	// Serial Communication Interface - USART_EXT
	SERCOM7_USART_EXT = (*SERCOM_USART_EXT_Type)(unsafe.Pointer(uintptr(0x43000c00)))

	// Serial Communication Interface - USART_INT
	SERCOM7_USART_INT = (*SERCOM_USART_INT_Type)(unsafe.Pointer(uintptr(0x43000c00)))
	...
	// Basic Timer Counter
	TC6 = (*TC_Type)(unsafe.Pointer(uintptr(0x43001400)))

	// Basic Timer Counter - COUNT8
	TC6_COUNT8 = (*TC_COUNT8_Type)(unsafe.Pointer(uintptr(0x43001400)))

	// Basic Timer Counter - COUNT16
	TC6_COUNT16 = (*TC_COUNT16_Type)(unsafe.Pointer(uintptr(0x43001400)))

	// Basic Timer Counter - COUNT32
	TC6_COUNT32 = (*TC_COUNT32_Type)(unsafe.Pointer(uintptr(0x43001400)))

	// Basic Timer Counter
	TC7 = (*TC_Type)(unsafe.Pointer(uintptr(0x43001800)))

	// Basic Timer Counter - COUNT8
	TC7_COUNT8 = (*TC_COUNT8_Type)(unsafe.Pointer(uintptr(0x43001800)))

	// Basic Timer Counter - COUNT16
	TC7_COUNT16 = (*TC_COUNT16_Type)(unsafe.Pointer(uintptr(0x43001800)))

	// Basic Timer Counter - COUNT32
	TC7_COUNT32 = (*TC_COUNT32_Type)(unsafe.Pointer(uintptr(0x43001800)))
...
type DMAC_Type struct {
	...
	_          [4]byte
	CHANNEL    [32]struct {
		CHCTRLA    volatile.Register32
		CHCTRLB    volatile.Register8
		CHPRILVL   volatile.Register8
		CHEVCTRL   volatile.Register8
		_          [5]byte
...
type GMAC_Type struct {
	...
	SA    [4]struct {
		SAB volatile.Register32
		SAT volatile.Register32
	} // 0x88
...
type HMATRIXB_Type struct {
	_   [128]byte
	PRS [16]struct {
		PRAS volatile.Register32
		PRBS volatile.Register32
	} // 0x80
}
...
type OSCCTRL_Type struct {
	...
	_         [3]byte
	DPLL      [2]struct {
		DPLLCTRLA    volatile.Register8
		_            [3]byte
		DPLLRATIO    volatile.Register32
		DPLLCTRLB    volatile.Register32
		DPLLSYNCBUSY volatile.Register32
		DPLLSTATUS   volatile.Register32
	} // 0x30
}
...
type USB_DEVICE_Type struct {
	...
	_               [214]byte
	DEVICE_ENDPOINT [8]struct {
		EPCFG       volatile.Register8
		_           [3]byte
		EPSTATUSCLR volatile.Register8
		EPSTATUSSET volatile.Register8
		EPSTATUS    volatile.Register8
		EPINTFLAG   volatile.Register8
		EPINTENCLR  volatile.Register8
		EPINTENSET  volatile.Register8
		_           [22]byte
	} // 0x100
}
...
type USB_HOST_Type struct {
	...
	_         [214]byte
	HOST_PIPE [8]struct {
		PCFG       volatile.Register8
		_          [2]byte
		BINTERVAL  volatile.Register8
		PSTATUSCLR volatile.Register8
		PSTATUSSET volatile.Register8
		PSTATUS    volatile.Register8
		PINTFLAG   volatile.Register8
		PINTENCLR  volatile.Register8
		PINTENSET  volatile.Register8
		_          [22]byte
	} // 0x100
}
...
// Bitfields for ADC0: Analog Digital Converter
const (
	// CTRLA: Control A
	// Position of SWRST field.
...
// Bitfields for CAN0: Control Area Network
const (
	// CREL: Core Release
...
// Bitfields for GMAC: Ethernet MAC
const (
...
// Bitfields for ICM: Integrity Check Monitor
const (
	// CFG: Configuration
...
const (
	...
	// Position of SDHC1_ field.
	MCLK_AHBMASK_SDHC1__Pos = 0x10
	// Bit mask of SDHC1_ field.
	MCLK_AHBMASK_SDHC1__Msk = 0x10000
	// Bit SDHC1_.
	MCLK_AHBMASK_SDHC1_ = 0x10000
...
// Bitfields for OSC32KCTRL: 32kHz Oscillators Control
const (
	// INTENCLR: Interrupt Enable Clear
...
const (
	...
	// Position of SDHC1_ field.
	PAC_INTFLAGAHB_SDHC1__Pos = 0xd
	// Bit mask of SDHC1_ field.
	PAC_INTFLAGAHB_SDHC1__Msk = 0x2000
	// Bit SDHC1_.
	PAC_INTFLAGAHB_SDHC1_ = 0x2000
	// Position of QSPI_ field.
...
// Bitfields for PCC: Parallel Capture Controller
const (
	// MR: Mode Register
...
// Bitfields for PDEC: Quadrature Decodeur
const (
	// CTRLA: Control A
	// Position of SWRST field.
...
// Bitfields for QSPI: Quad SPI interface
const (
	// CTRLA: Control A
	// Position of SWRST field.
...
// Bitfields for SDHC0: SD/MMC Host Controller
const (
...
// Bitfields for SERCOM0_SPIS: Serial Communication Interface - SPIS
const (
...
// Bitfields for SERCOM0_SPIM: Serial Communication Interface - SPIM
const (
...
// Bitfields for SERCOM0_USART_EXT: Serial Communication Interface - USART_EXT
const (
...
// Bitfields for SERCOM0_USART_INT: Serial Communication Interface - USART_INT
const (
...
// Bitfields for TCC0: Timer Counter Control
const (
	// CTRLA: Control A
	// Position of SWRST field.
...
// Bitfields for CoreDebug: Core Debug Register
const (
...
// Bitfields for DWT: Data Watchpoint and Trace Register
const (
...
// Bitfields for ETM: Embedded Trace Macrocell
const (
...
// Bitfields for FPU: Floating Point Unit
const (
...
// Bitfields for ITM: Instrumentation Trace Macrocell
const (
...
// Bitfields for SystemControl: System Control Registers
const (
...
// Bitfields for TPI: Trace Port Interface Register
const (
