...
// Generated by gen-device-svd.go from ATSAME54P20A.svd, see https://github.com/posborne/cmsis-svd/tree/master/data/Atmel

//go:build sam && atsame54p20a
// +build sam,atsame54p20a

// Microchip ATSAME54P20A Microcontroller
//
