...
// Generated by gen-device-svd.go from ATSAMR21G18A.svd, see https://github.com/posborne/cmsis-svd/tree/master/data/Atmel

//go:build sam && atsamr21g18a
// +build sam,atsamr21g18a

// Atmel ATSAMR21G18A device: Cortex-M0+ Microcontroller with 256KB Flash, 32KB SRAM, 233-pin package (refer to http://www.atmel.com/devices/SAMR21G18A.aspx for more)
//
//     ============================================================================
...
//export PM_INTREQ_IRQHandler
func interruptPM_INTREQ() {
	callHandlers(IRQ_PM_INTREQ)
}

//export SYSCTRL_INTREQ_IRQHandler
func interruptSYSCTRL_INTREQ() {
	callHandlers(IRQ_SYSCTRL_INTREQ)
}

//export WDT_INTREQ_IRQHandler
func interruptWDT_INTREQ() {
	callHandlers(IRQ_WDT_INTREQ)
}

//export RTC_INTREQ_IRQHandler
func interruptRTC_INTREQ() {
	callHandlers(IRQ_RTC_INTREQ)
}

//export EIC_INTREQ_IRQHandler
func interruptEIC_INTREQ() {
	callHandlers(IRQ_EIC_INTREQ)
}

//export NVMCTRL_INTREQ_IRQHandler
func interruptNVMCTRL_INTREQ() {
	callHandlers(IRQ_NVMCTRL_INTREQ)
}

//export DMAC_INTREQ_IRQHandler
func interruptDMAC_INTREQ() {
	callHandlers(IRQ_DMAC_INTREQ)
}

//export USB_INTREQ_IRQHandler
func interruptUSB_INTREQ() {
	callHandlers(IRQ_USB_INTREQ)
}

//export EVSYS_INTREQ_IRQHandler
func interruptEVSYS_INTREQ() {
	callHandlers(IRQ_EVSYS_INTREQ)
}

//export SERCOM0_INTREQ_IRQHandler
func interruptSERCOM0_INTREQ() {
	callHandlers(IRQ_SERCOM0_INTREQ)
}

//export SERCOM1_INTREQ_IRQHandler
func interruptSERCOM1_INTREQ() {
	callHandlers(IRQ_SERCOM1_INTREQ)
}

//export SERCOM2_INTREQ_IRQHandler
func interruptSERCOM2_INTREQ() {
	callHandlers(IRQ_SERCOM2_INTREQ)
}

//export SERCOM3_INTREQ_IRQHandler
func interruptSERCOM3_INTREQ() {
	callHandlers(IRQ_SERCOM3_INTREQ)
}

//export SERCOM4_INTREQ_IRQHandler
func interruptSERCOM4_INTREQ() {
	callHandlers(IRQ_SERCOM4_INTREQ)
}

//export SERCOM5_INTREQ_IRQHandler
func interruptSERCOM5_INTREQ() {
	callHandlers(IRQ_SERCOM5_INTREQ)
}

//export TCC0_INTREQ_IRQHandler
func interruptTCC0_INTREQ() {
	callHandlers(IRQ_TCC0_INTREQ)
}

//export TCC1_INTREQ_IRQHandler
func interruptTCC1_INTREQ() {
	callHandlers(IRQ_TCC1_INTREQ)
}

//export TCC2_INTREQ_IRQHandler
func interruptTCC2_INTREQ() {
	callHandlers(IRQ_TCC2_INTREQ)
}

//export TC3_INTREQ_IRQHandler
func interruptTC3_INTREQ() {
	callHandlers(IRQ_TC3_INTREQ)
}

//export TC4_INTREQ_IRQHandler
func interruptTC4_INTREQ() {
	callHandlers(IRQ_TC4_INTREQ)
}

//export TC5_INTREQ_IRQHandler
func interruptTC5_INTREQ() {
	callHandlers(IRQ_TC5_INTREQ)
}

//export TC6_INTREQ_IRQHandler
func interruptTC6_INTREQ() {
	callHandlers(IRQ_TC6_INTREQ)
}

//export TC7_INTREQ_IRQHandler
func interruptTC7_INTREQ() {
	callHandlers(IRQ_TC7_INTREQ)
}

//export ADC_INTREQ_IRQHandler
func interruptADC_INTREQ() {
	callHandlers(IRQ_ADC_INTREQ)
}

//export AC_INTREQ_IRQHandler
func interruptAC_INTREQ() {
	callHandlers(IRQ_AC_INTREQ)
}

//export DAC_INTREQ_IRQHandler
func interruptDAC_INTREQ() {
	callHandlers(IRQ_DAC_INTREQ)
}
