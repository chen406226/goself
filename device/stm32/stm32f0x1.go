...
//go:build stm32 && stm32f0x1
// +build stm32,stm32f0x1
...
const (
	...
	// Position of TIM3_counter_stopped_when_core_is_halted field.
	DBGMCU_APB1_FZ_TIM3_counter_stopped_when_core_is_halted_Pos = 0x4
	// Bit mask of TIM3_counter_stopped_when_core_is_halted field.
	DBGMCU_APB1_FZ_TIM3_counter_stopped_when_core_is_halted_Msk = 0x10
	// Bit TIM3_counter_stopped_when_core_is_halted.
	DBGMCU_APB1_FZ_TIM3_counter_stopped_when_core_is_halted = 0x10
