...
//go:build stm32 && stm32f0x2
// +build stm32,stm32f0x2
...
//export DMA1_CH4_5_6_7_IRQHandler
func interruptDMA1_CH4_5_6_7() {
	callHandlers(IRQ_DMA1_CH4_5_6_7)
}
...
//export USART3_4_IRQHandler
func interruptUSART3_4() {
	callHandlers(IRQ_USART3_4)
}
...
const (
	...
	EXTI_PR_PIF31_Pos = 0x1f
	// Bit mask of PIF31 field.
	EXTI_PR_PIF31_Msk = 0x80000000
	// Bit PIF31.
	EXTI_PR_PIF31 = 0x80000000
	// No trigger request occurred
	EXTI_PR_PIF31_NotPending = 0x0
	// Selected trigger request occurred
	EXTI_PR_PIF31_Pending = 0x1
	// Clears pending bit
	EXTI_PR_PIF31_Clear = 0x1
