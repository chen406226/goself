...
//export TIM4_IRQ_IRQHandler
func interruptTIM4_IRQ() {
	callHandlers(IRQ_TIM4_IRQ)
}
...
//export TIM5_IRQ_IRQHandler
func interruptTIM5_IRQ() {
	callHandlers(IRQ_TIM5_IRQ)
}
...
//export TIM19_IRQ_IRQHandler
func interruptTIM19_IRQ() {
	callHandlers(IRQ_TIM19_IRQ)
}
...
const (
	...
	DAC2_CR_DMAUDRIE1_Disabled = 0x0
	// DAC channel X DMA Underrun Interrupt enabled
	DAC2_CR_DMAUDRIE1_Enabled = 0x1
	...
	DAC2_CR_DMAEN1_Disabled = 0x0
	// DAC channel X DMA mode enabled
	DAC2_CR_DMAEN1_Enabled = 0x1
	...
	// Timer 6 TRGO event
	DAC2_CR_TSEL1_TIM6_TRGO = 0x0
	// Timer 3 TRGO event
	DAC2_CR_TSEL1_TIM3_TRGO = 0x1
	// Timer 7 TRGO event
	DAC2_CR_TSEL1_TIM7_TRGO = 0x2
	// Timer 15 TRGO event
	DAC2_CR_TSEL1_TIM15_TRGO = 0x3
	// Timer 2 TRGO event
	DAC2_CR_TSEL1_TIM2_TRGO = 0x4
	// EXTI line9
	DAC2_CR_TSEL1_EXTI9 = 0x6
	// Software trigger
	DAC2_CR_TSEL1_SOFTWARE = 0x7
	...
	DAC2_CR_TEN1_Disabled = 0x0
	// DAC channel X trigger enabled
	DAC2_CR_TEN1_Enabled = 0x1
	...
	DAC2_CR_BOFF1_Enabled = 0x0
	// DAC channel X output buffer disabled
	DAC2_CR_BOFF1_Disabled = 0x1
	...
	DAC2_CR_EN1_Disabled = 0x0
	// DAC channel X enabled
	DAC2_CR_EN1_Enabled = 0x1
	...
	DAC2_SWTRIGR_SWTRIG1_Disabled = 0x0
	// DAC channel X software trigger enabled
	DAC2_SWTRIGR_SWTRIG1_Enabled = 0x1
	...
	DAC2_SR_DMAUDR1_NoUnderrun = 0x0
	// DMA underrun error condition occurred for DAC channel X
	DAC2_SR_DMAUDR1_Underrun = 0x1
)
...
const (
	...
	TIMs_CR2_OIS2N_Pos = 0xb
	// Bit mask of OIS2N field.
	TIMs_CR2_OIS2N_Msk = 0x800
	// Bit OIS2N.
	TIMs_CR2_OIS2N = 0x800
	// Position of OIS3 field.
	TIMs_CR2_OIS3_Pos = 0xc
	// Bit mask of OIS3 field.
	TIMs_CR2_OIS3_Msk = 0x1000
	// Bit OIS3.
	TIMs_CR2_OIS3 = 0x1000
	// Position of OIS3N field.
	TIMs_CR2_OIS3N_Pos = 0xd
	// Bit mask of OIS3N field.
	TIMs_CR2_OIS3N_Msk = 0x2000
	// Bit OIS3N.
	TIMs_CR2_OIS3N = 0x2000
	// Position of OIS4 field.
	TIMs_CR2_OIS4_Pos = 0xe
	// Bit mask of OIS4 field.
	TIMs_CR2_OIS4_Msk = 0x4000
	// Bit OIS4.
	TIMs_CR2_OIS4 = 0x4000
	// Position of OIS5 field.
	TIMs_CR2_OIS5_Pos = 0x10
	// Bit mask of OIS5 field.
	TIMs_CR2_OIS5_Msk = 0x10000
	// Bit OIS5.
	TIMs_CR2_OIS5 = 0x10000
	// Position of OIS6 field.
	TIMs_CR2_OIS6_Pos = 0x12
	// Bit mask of OIS6 field.
	TIMs_CR2_OIS6_Msk = 0x40000
	// Bit OIS6.
	TIMs_CR2_OIS6 = 0x40000
	// Position of MMS2 field.
	TIMs_CR2_MMS2_Pos = 0x14
	// Bit mask of MMS2 field.
	TIMs_CR2_MMS2_Msk = 0xf00000
	...
	TIMs_SMCR_SMS3_Pos = 0x10
	// Bit mask of SMS3 field.
	TIMs_SMCR_SMS3_Msk = 0x10000
	// Bit SMS3.
	TIMs_SMCR_SMS3 = 0x10000
	...
	TIMs_SR_B2IF_Pos = 0x8
	// Bit mask of B2IF field.
	TIMs_SR_B2IF_Msk = 0x100
	// Bit B2IF.
	TIMs_SR_B2IF = 0x100
	// Position of CC1OF field.
	...
	// Position of C5IF field.
	TIMs_SR_C5IF_Pos = 0x10
	// Bit mask of C5IF field.
	TIMs_SR_C5IF_Msk = 0x10000
	// Bit C5IF.
	TIMs_SR_C5IF = 0x10000
	// Position of C6IF field.
	TIMs_SR_C6IF_Pos = 0x11
	// Bit mask of C6IF field.
	TIMs_SR_C6IF_Msk = 0x20000
	// Bit C6IF.
	TIMs_SR_C6IF = 0x20000
	...
	TIMs_EGR_B2G_Pos = 0x8
	// Bit mask of B2G field.
	TIMs_EGR_B2G_Msk = 0x100
	// Bit B2G.
	TIMs_EGR_B2G = 0x100
	...
	TIMs_CCER_CC2NE_Pos = 0x6
	// Bit mask of CC2NE field.
	TIMs_CCER_CC2NE_Msk = 0x40
	// Bit CC2NE.
	TIMs_CCER_CC2NE = 0x40
	// Position of CC2NP field.
	...
	TIMs_CCER_CC3NE_Pos = 0xa
	// Bit mask of CC3NE field.
	TIMs_CCER_CC3NE_Msk = 0x400
	// Bit CC3NE.
	TIMs_CCER_CC3NE = 0x400
	// Position of CC3NP field.
	...
	TIMs_CCER_CC5E_Pos = 0x10
	// Bit mask of CC5E field.
	TIMs_CCER_CC5E_Msk = 0x10000
	// Bit CC5E.
	TIMs_CCER_CC5E = 0x10000
	// Position of CC5P field.
	TIMs_CCER_CC5P_Pos = 0x11
	// Bit mask of CC5P field.
	TIMs_CCER_CC5P_Msk = 0x20000
	// Bit CC5P.
	TIMs_CCER_CC5P = 0x20000
	// Position of CC6E field.
	TIMs_CCER_CC6E_Pos = 0x14
	// Bit mask of CC6E field.
	TIMs_CCER_CC6E_Msk = 0x100000
	// Bit CC6E.
	TIMs_CCER_CC6E = 0x100000
	// Position of CC6P field.
	TIMs_CCER_CC6P_Pos = 0x15
	// Bit mask of CC6P field.
	TIMs_CCER_CC6P_Msk = 0x200000
	// Bit CC6P.
	TIMs_CCER_CC6P = 0x200000
	...
	TIMs_BDTR_OSSI_Disabled = 0x0
	// When inactive, OC/OCN outputs are forced to idle level
	TIMs_BDTR_OSSI_IdleLevel = 0x1
	...
	TIMs_CCMR3_Output_OC5FE_Pos = 0x2
	// Bit mask of OC5FE field.
	TIMs_CCMR3_Output_OC5FE_Msk = 0x4
	// Bit OC5FE.
	TIMs_CCMR3_Output_OC5FE = 0x4
	// Position of OC5PE field.
	TIMs_CCMR3_Output_OC5PE_Pos = 0x3
	// Bit mask of OC5PE field.
	TIMs_CCMR3_Output_OC5PE_Msk = 0x8
	// Bit OC5PE.
	TIMs_CCMR3_Output_OC5PE = 0x8
	// Position of OC5M field.
	TIMs_CCMR3_Output_OC5M_Pos = 0x4
	// Bit mask of OC5M field.
	TIMs_CCMR3_Output_OC5M_Msk = 0x70
	// Position of OC5CE field.
	TIMs_CCMR3_Output_OC5CE_Pos = 0x7
	// Bit mask of OC5CE field.
	TIMs_CCMR3_Output_OC5CE_Msk = 0x80
	// Bit OC5CE.
	TIMs_CCMR3_Output_OC5CE = 0x80
	// Position of OC6FE field.
	TIMs_CCMR3_Output_OC6FE_Pos = 0xa
	// Bit mask of OC6FE field.
	TIMs_CCMR3_Output_OC6FE_Msk = 0x400
	// Bit OC6FE.
	TIMs_CCMR3_Output_OC6FE = 0x400
	// Position of OC6PE field.
	TIMs_CCMR3_Output_OC6PE_Pos = 0xb
	// Bit mask of OC6PE field.
	TIMs_CCMR3_Output_OC6PE_Msk = 0x800
	// Bit OC6PE.
	TIMs_CCMR3_Output_OC6PE = 0x800
	// Position of OC6M field.
	TIMs_CCMR3_Output_OC6M_Pos = 0xc
	// Bit mask of OC6M field.
	TIMs_CCMR3_Output_OC6M_Msk = 0x7000
	// Position of OC6CE field.
	TIMs_CCMR3_Output_OC6CE_Pos = 0xf
	// Bit mask of OC6CE field.
	TIMs_CCMR3_Output_OC6CE_Msk = 0x8000
	// Bit OC6CE.
	TIMs_CCMR3_Output_OC6CE = 0x8000
	// Position of OC5M_3 field.
	TIMs_CCMR3_Output_OC5M_3_Pos = 0x10
	// Bit mask of OC5M_3 field.
	TIMs_CCMR3_Output_OC5M_3_Msk = 0x10000
	// Bit OC5M_3.
	TIMs_CCMR3_Output_OC5M_3 = 0x10000
	// Position of OC6M_3 field.
	TIMs_CCMR3_Output_OC6M_3_Pos = 0x18
	// Bit mask of OC6M_3 field.
	TIMs_CCMR3_Output_OC6M_3_Msk = 0x1000000
	// Bit OC6M_3.
	TIMs_CCMR3_Output_OC6M_3 = 0x1000000

	// CCR5: capture/compare register 5
	// Position of CCR field.
	TIMs_CCR5_CCR_Pos = 0x0
	// Bit mask of CCR field.
	TIMs_CCR5_CCR_Msk = 0xffff
	// Position of GC5C1 field.
	TIMs_CCR5_GC5C1_Pos = 0x1d
	// Bit mask of GC5C1 field.
	TIMs_CCR5_GC5C1_Msk = 0x20000000
	// Bit GC5C1.
	TIMs_CCR5_GC5C1 = 0x20000000
	// Position of GC5C2 field.
	TIMs_CCR5_GC5C2_Pos = 0x1e
	// Bit mask of GC5C2 field.
	TIMs_CCR5_GC5C2_Msk = 0x40000000
	// Bit GC5C2.
	TIMs_CCR5_GC5C2 = 0x40000000
	// Position of GC5C3 field.
	TIMs_CCR5_GC5C3_Pos = 0x1f
	// Bit mask of GC5C3 field.
	TIMs_CCR5_GC5C3_Msk = 0x80000000
	// Bit GC5C3.
	TIMs_CCR5_GC5C3 = 0x80000000

	// CCR6: capture/compare register 6
	// Position of CCR field.
	TIMs_CCR6_CCR_Pos = 0x0
	// Bit mask of CCR field.
	TIMs_CCR6_CCR_Msk = 0xffff

	// OR: option registers
	// Position of TIM1_ETR_ADC1_RMP field.
	TIMs_OR_TIM1_ETR_ADC1_RMP_Pos = 0x0
	// Bit mask of TIM1_ETR_ADC1_RMP field.
	TIMs_OR_TIM1_ETR_ADC1_RMP_Msk = 0x3
	// Position of TIM1_ETR_ADC4_RMP field.
	TIMs_OR_TIM1_ETR_ADC4_RMP_Pos = 0x2
	// Bit mask of TIM1_ETR_ADC4_RMP field.
	TIMs_OR_TIM1_ETR_ADC4_RMP_Msk = 0xc
)
