...
//go:build stm32 && stm32f412
// +build stm32,stm32f412
...
const (
	...
	// Inter-integrated circuit
	IRQ_I2CFMP1_event = 95

	// Inter-integrated circuit
	IRQ_I2CFMP1_error = 96
...
//export TIM12_IRQHandler
func interruptTIM12() {
	callHandlers(IRQ_TIM12)
}

//export TIM13_IRQHandler
func interruptTIM13() {
	callHandlers(IRQ_TIM13)
}
...
//export Quad_SPI_IRQHandler
func interruptQuad_SPI() {
	callHandlers(IRQ_Quad_SPI)
}

//export I2CFMP1_event_IRQHandler
func interruptI2CFMP1_event() {
	callHandlers(IRQ_I2CFMP1_event)
}

//export I2CFMP1_error_IRQHandler
func interruptI2CFMP1_error() {
	callHandlers(IRQ_I2CFMP1_error)
}
...
const (
	...
	// AHB3RSTR: RCC AHB3 peripheral reset register
	...
	// AHB3ENR: RCC AHB3 peripheral clock enable register
	...
	RCC_DCKCFGR_CKDFSDM1ASEL_Msk = 0xf8000
	...
	// DCKCFGR2: Dedicated Clock Configuration Register
...
const (
	...
	// FSMC_CLK is only generated during the synchronous memory access
...
const (
	...
	USB_OTG_FS_GCCFG_DCDET_Pos = 0x0
	// Bit mask of DCDET field.
	USB_OTG_FS_GCCFG_DCDET_Msk = 0x1
	// Bit DCDET.
	USB_OTG_FS_GCCFG_DCDET = 0x1
	// Position of PDET field.
	USB_OTG_FS_GCCFG_PDET_Pos = 0x1
	// Bit mask of PDET field.
	USB_OTG_FS_GCCFG_PDET_Msk = 0x2
	// Bit PDET.
	USB_OTG_FS_GCCFG_PDET = 0x2
	// Position of SDET field.
	USB_OTG_FS_GCCFG_SDET_Pos = 0x2
	// Bit mask of SDET field.
	USB_OTG_FS_GCCFG_SDET_Msk = 0x4
	// Bit SDET.
	USB_OTG_FS_GCCFG_SDET = 0x4
	// Position of PS2DET field.
	USB_OTG_FS_GCCFG_PS2DET_Pos = 0x3
	// Bit mask of PS2DET field.
	USB_OTG_FS_GCCFG_PS2DET_Msk = 0x8
	// Bit PS2DET.
	USB_OTG_FS_GCCFG_PS2DET = 0x8
	...
	USB_OTG_FS_GCCFG_BCDEN_Pos = 0x11
	// Bit mask of BCDEN field.
	USB_OTG_FS_GCCFG_BCDEN_Msk = 0x20000
	// Bit BCDEN.
	USB_OTG_FS_GCCFG_BCDEN = 0x20000
	// Position of DCDEN field.
	USB_OTG_FS_GCCFG_DCDEN_Pos = 0x12
	// Bit mask of DCDEN field.
	USB_OTG_FS_GCCFG_DCDEN_Msk = 0x40000
	// Bit DCDEN.
	USB_OTG_FS_GCCFG_DCDEN = 0x40000
	// Position of PDEN field.
	USB_OTG_FS_GCCFG_PDEN_Pos = 0x13
	// Bit mask of PDEN field.
	USB_OTG_FS_GCCFG_PDEN_Msk = 0x80000
	// Bit PDEN.
	USB_OTG_FS_GCCFG_PDEN = 0x80000
	// Position of SDEN field.
	USB_OTG_FS_GCCFG_SDEN_Pos = 0x14
	// Bit mask of SDEN field.
	USB_OTG_FS_GCCFG_SDEN_Msk = 0x100000
	// Bit SDEN.
	USB_OTG_FS_GCCFG_SDEN = 0x100000
	// Position of VBDEN field.
	USB_OTG_FS_GCCFG_VBDEN_Pos = 0x15
	// Bit mask of VBDEN field.
	USB_OTG_FS_GCCFG_VBDEN_Msk = 0x200000
	// Bit VBDEN.
	USB_OTG_FS_GCCFG_VBDEN = 0x200000
	...
	// DIEPTXF2: OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF3)
	// Position of INEPTXSA field.
	...
	// DIEPTXF3: OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF4)
	// Position of INEPTXSA field.
