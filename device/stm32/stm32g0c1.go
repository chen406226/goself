...
type AES_Type struct {
	...
	AES_SR     volatile.Register32 // 0x4
	AES_DINR   volatile.Register32 // 0x8
	AES_DOUTR  volatile.Register32 // 0xC
	AES_KEYR0  volatile.Register32 // 0x10
	AES_KEYR1  volatile.Register32 // 0x14
	AES_KEYR2  volatile.Register32 // 0x18
	AES_KEYR3  volatile.Register32 // 0x1C
	AES_IVR0   volatile.Register32 // 0x20
	AES_IVR1   volatile.Register32 // 0x24
	AES_IVR2   volatile.Register32 // 0x28
	AES_IVR3   volatile.Register32 // 0x2C
	AES_KEYR4  volatile.Register32 // 0x30
	AES_KEYR5  volatile.Register32 // 0x34
	AES_KEYR6  volatile.Register32 // 0x38
	AES_KEYR7  volatile.Register32 // 0x3C
	AES_SUSP0R volatile.Register32 // 0x40
	AES_SUSP1R volatile.Register32 // 0x44
	AES_SUSP2R volatile.Register32 // 0x48
	AES_SUSP3R volatile.Register32 // 0x4C
	AES_SUSP4R volatile.Register32 // 0x50
	AES_SUSP5R volatile.Register32 // 0x54
	AES_SUSP6R volatile.Register32 // 0x58
	AES_SUSP7R volatile.Register32 // 0x5C
}
...
const (
	...
	AES_AES_CR_EN_Pos = 0x0
	// Bit mask of EN field.
	AES_AES_CR_EN_Msk = 0x1
	// Bit EN.
	AES_AES_CR_EN = 0x1
	// Disable
	AES_AES_CR_EN_B_0x0 = 0x0
	// Enable
	AES_AES_CR_EN_B_0x1 = 0x1
	// Position of DATATYPE field.
	AES_AES_CR_DATATYPE_Pos = 0x1
	// Bit mask of DATATYPE field.
	AES_AES_CR_DATATYPE_Msk = 0x6
	// None
	AES_AES_CR_DATATYPE_B_0x0 = 0x0
	// Half-word (16-bit)
	AES_AES_CR_DATATYPE_B_0x1 = 0x1
	// Byte (8-bit)
	AES_AES_CR_DATATYPE_B_0x2 = 0x2
	// Bit
	AES_AES_CR_DATATYPE_B_0x3 = 0x3
	// Position of MODE field.
	AES_AES_CR_MODE_Pos = 0x3
	// Bit mask of MODE field.
	AES_AES_CR_MODE_Msk = 0x18
	// Mode 1: encryption
	AES_AES_CR_MODE_B_0x0 = 0x0
	// Mode 2: key derivation (or key preparation for ECB/CBC decryption)
	AES_AES_CR_MODE_B_0x1 = 0x1
	// Mode 3: decryption
	AES_AES_CR_MODE_B_0x2 = 0x2
	// Mode 4: key derivation then single decryption
	AES_AES_CR_MODE_B_0x3 = 0x3
	// Position of CHMOD1 field.
	AES_AES_CR_CHMOD1_Pos = 0x5
	// Bit mask of CHMOD1 field.
	AES_AES_CR_CHMOD1_Msk = 0x60
	// Electronic codebook (ECB)
	AES_AES_CR_CHMOD1_B_0x0 = 0x0
	// Cipher-Block Chaining (CBC)
	AES_AES_CR_CHMOD1_B_0x1 = 0x1
	// Counter Mode (CTR)
	AES_AES_CR_CHMOD1_B_0x2 = 0x2
	// Galois Counter Mode (GCM) and Galois Message Authentication Code (GMAC)
	AES_AES_CR_CHMOD1_B_0x3 = 0x3
	// Counter with CBC-MAC (CCM)
	AES_AES_CR_CHMOD1_B_0x4 = 0x4
	// Position of CCFC field.
	AES_AES_CR_CCFC_Pos = 0x7
	// Bit mask of CCFC field.
	AES_AES_CR_CCFC_Msk = 0x80
	// Bit CCFC.
	AES_AES_CR_CCFC = 0x80
	// No effect
	AES_AES_CR_CCFC_B_0x0 = 0x0
	// Clear CCF
	AES_AES_CR_CCFC_B_0x1 = 0x1
	// Position of ERRC field.
	AES_AES_CR_ERRC_Pos = 0x8
	// Bit mask of ERRC field.
	AES_AES_CR_ERRC_Msk = 0x100
	// Bit ERRC.
	AES_AES_CR_ERRC = 0x100
	// No effect
	AES_AES_CR_ERRC_B_0x0 = 0x0
	// Clear RDERR and WRERR flags
	AES_AES_CR_ERRC_B_0x1 = 0x1
	// Position of CCFIE field.
	AES_AES_CR_CCFIE_Pos = 0x9
	// Bit mask of CCFIE field.
	AES_AES_CR_CCFIE_Msk = 0x200
	// Bit CCFIE.
	AES_AES_CR_CCFIE = 0x200
	// Disable (mask)
	AES_AES_CR_CCFIE_B_0x0 = 0x0
	// Enable
	AES_AES_CR_CCFIE_B_0x1 = 0x1
	// Position of ERRIE field.
	AES_AES_CR_ERRIE_Pos = 0xa
	// Bit mask of ERRIE field.
	AES_AES_CR_ERRIE_Msk = 0x400
	// Bit ERRIE.
	AES_AES_CR_ERRIE = 0x400
	// Disable (mask)
	AES_AES_CR_ERRIE_B_0x0 = 0x0
	// Enable
	AES_AES_CR_ERRIE_B_0x1 = 0x1
	// Position of DMAINEN field.
	AES_AES_CR_DMAINEN_Pos = 0xb
	// Bit mask of DMAINEN field.
	AES_AES_CR_DMAINEN_Msk = 0x800
	// Bit DMAINEN.
	AES_AES_CR_DMAINEN = 0x800
	// Disable
	AES_AES_CR_DMAINEN_B_0x0 = 0x0
	// Enable
	AES_AES_CR_DMAINEN_B_0x1 = 0x1
	// Position of DMAOUTEN field.
	AES_AES_CR_DMAOUTEN_Pos = 0xc
	// Bit mask of DMAOUTEN field.
	AES_AES_CR_DMAOUTEN_Msk = 0x1000
	// Bit DMAOUTEN.
	AES_AES_CR_DMAOUTEN = 0x1000
	// Disable
	AES_AES_CR_DMAOUTEN_B_0x0 = 0x0
	// Enable
	AES_AES_CR_DMAOUTEN_B_0x1 = 0x1
	// Position of GCMPH field.
	AES_AES_CR_GCMPH_Pos = 0xd
	// Bit mask of GCMPH field.
	AES_AES_CR_GCMPH_Msk = 0x6000
	// Init phase
	AES_AES_CR_GCMPH_B_0x0 = 0x0
	// Header phase
	AES_AES_CR_GCMPH_B_0x1 = 0x1
	// Payload phase
	AES_AES_CR_GCMPH_B_0x2 = 0x2
	// Final phase
	AES_AES_CR_GCMPH_B_0x3 = 0x3
	// Position of CHMOD2 field.
	AES_AES_CR_CHMOD2_Pos = 0x10
	// Bit mask of CHMOD2 field.
	AES_AES_CR_CHMOD2_Msk = 0x10000
	// Bit CHMOD2.
	AES_AES_CR_CHMOD2 = 0x10000
	// Electronic codebook (ECB)
	AES_AES_CR_CHMOD2_B_0x0 = 0x0
	// Cipher-Block Chaining (CBC)
	AES_AES_CR_CHMOD2_B_0x1 = 0x1
	// Counter Mode (CTR)
	AES_AES_CR_CHMOD2_B_0x2 = 0x2
	// Galois Counter Mode (GCM) and Galois Message Authentication Code (GMAC)
	AES_AES_CR_CHMOD2_B_0x3 = 0x3
	// Counter with CBC-MAC (CCM)
	AES_AES_CR_CHMOD2_B_0x4 = 0x4
	// Position of KEYSIZE field.
	AES_AES_CR_KEYSIZE_Pos = 0x12
	// Bit mask of KEYSIZE field.
	AES_AES_CR_KEYSIZE_Msk = 0x40000
	// Bit KEYSIZE.
	AES_AES_CR_KEYSIZE = 0x40000
	// 128
	AES_AES_CR_KEYSIZE_B_0x0 = 0x0
	// 256
	AES_AES_CR_KEYSIZE_B_0x1 = 0x1
	// Position of NPBLB field.
	AES_AES_CR_NPBLB_Pos = 0x14
	// Bit mask of NPBLB field.
	AES_AES_CR_NPBLB_Msk = 0xf00000
	// All bytes are valid (no padding)
	AES_AES_CR_NPBLB_B_0x0 = 0x0
	// Padding for one least-significant byte of last block
	AES_AES_CR_NPBLB_B_0x1 = 0x1
	// Padding for 15 least-significant bytes of last block
	AES_AES_CR_NPBLB_B_0xF = 0xf

	// AES_SR: AES status register
	// Position of CCF field.
	AES_AES_SR_CCF_Pos = 0x0
	// Bit mask of CCF field.
	AES_AES_SR_CCF_Msk = 0x1
	// Bit CCF.
	AES_AES_SR_CCF = 0x1
	// Not completed
	AES_AES_SR_CCF_B_0x0 = 0x0
	// Completed
	AES_AES_SR_CCF_B_0x1 = 0x1
	// Position of RDERR field.
	AES_AES_SR_RDERR_Pos = 0x1
	// Bit mask of RDERR field.
	AES_AES_SR_RDERR_Msk = 0x2
	// Bit RDERR.
	AES_AES_SR_RDERR = 0x2
	// Not detected
	AES_AES_SR_RDERR_B_0x0 = 0x0
	// Detected
	AES_AES_SR_RDERR_B_0x1 = 0x1
	// Position of WRERR field.
	AES_AES_SR_WRERR_Pos = 0x2
	// Bit mask of WRERR field.
	AES_AES_SR_WRERR_Msk = 0x4
	// Bit WRERR.
	AES_AES_SR_WRERR = 0x4
	// Not detected
	AES_AES_SR_WRERR_B_0x0 = 0x0
	// Detected
	AES_AES_SR_WRERR_B_0x1 = 0x1
	// Position of BUSY field.
	AES_AES_SR_BUSY_Pos = 0x3
	// Bit mask of BUSY field.
	AES_AES_SR_BUSY_Msk = 0x8
	// Bit BUSY.
	AES_AES_SR_BUSY = 0x8
	// Idle
	AES_AES_SR_BUSY_B_0x0 = 0x0
	// Busy
	AES_AES_SR_BUSY_B_0x1 = 0x1

	// AES_DINR: AES data input register
	// Position of DIN field.
	AES_AES_DINR_DIN_Pos = 0x0
	// Bit mask of DIN field.
	AES_AES_DINR_DIN_Msk = 0xffffffff

	// AES_DOUTR: AES data output register
	// Position of DOUT field.
	AES_AES_DOUTR_DOUT_Pos = 0x0
	// Bit mask of DOUT field.
	AES_AES_DOUTR_DOUT_Msk = 0xffffffff

	// AES_KEYR0: AES key register 0
	// Position of KEY field.
	AES_AES_KEYR0_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR0_KEY_Msk = 0xffffffff

	// AES_KEYR1: AES key register 1
	// Position of KEY field.
	AES_AES_KEYR1_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR1_KEY_Msk = 0xffffffff

	// AES_KEYR2: AES key register 2
	// Position of KEY field.
	AES_AES_KEYR2_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR2_KEY_Msk = 0xffffffff

	// AES_KEYR3: AES key register 3
	// Position of KEY field.
	AES_AES_KEYR3_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR3_KEY_Msk = 0xffffffff

	// AES_IVR0: AES initialization vector register 0
	// Position of IVI field.
	AES_AES_IVR0_IVI_Pos = 0x0
	// Bit mask of IVI field.
	AES_AES_IVR0_IVI_Msk = 0xffffffff

	// AES_IVR1: AES initialization vector register 1
	// Position of IVI field.
	AES_AES_IVR1_IVI_Pos = 0x0
	// Bit mask of IVI field.
	AES_AES_IVR1_IVI_Msk = 0xffffffff

	// AES_IVR2: AES initialization vector register 2
	// Position of IVI field.
	AES_AES_IVR2_IVI_Pos = 0x0
	// Bit mask of IVI field.
	AES_AES_IVR2_IVI_Msk = 0xffffffff

	// AES_IVR3: AES initialization vector register 3
	// Position of IVI field.
	AES_AES_IVR3_IVI_Pos = 0x0
	// Bit mask of IVI field.
	AES_AES_IVR3_IVI_Msk = 0xffffffff

	// AES_KEYR4: AES key register 4
	// Position of KEY field.
	AES_AES_KEYR4_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR4_KEY_Msk = 0xffffffff

	// AES_KEYR5: AES key register 5
	// Position of KEY field.
	AES_AES_KEYR5_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR5_KEY_Msk = 0xffffffff

	// AES_KEYR6: AES key register 6
	// Position of KEY field.
	AES_AES_KEYR6_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR6_KEY_Msk = 0xffffffff

	// AES_KEYR7: AES key register 7
	// Position of KEY field.
	AES_AES_KEYR7_KEY_Pos = 0x0
	// Bit mask of KEY field.
	AES_AES_KEYR7_KEY_Msk = 0xffffffff

	// AES_SUSP0R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP0R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP0R_SUSP_Msk = 0xffffffff

	// AES_SUSP1R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP1R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP1R_SUSP_Msk = 0xffffffff

	// AES_SUSP2R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP2R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP2R_SUSP_Msk = 0xffffffff

	// AES_SUSP3R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP3R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP3R_SUSP_Msk = 0xffffffff

	// AES_SUSP4R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP4R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP4R_SUSP_Msk = 0xffffffff

	// AES_SUSP5R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP5R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP5R_SUSP_Msk = 0xffffffff

	// AES_SUSP6R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP6R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP6R_SUSP_Msk = 0xffffffff

	// AES_SUSP7R: AES suspend registers
	// Position of SUSP field.
	AES_AES_SUSP7R_SUSP_Pos = 0x0
	// Bit mask of SUSP field.
	AES_AES_SUSP7R_SUSP_Msk = 0xffffffff
)
...
const (
	...
	RNG_RNG_CR_RNGEN_Pos = 0x2
	// Bit mask of RNGEN field.
	RNG_RNG_CR_RNGEN_Msk = 0x4
	// Bit RNGEN.
	RNG_RNG_CR_RNGEN = 0x4
	...
	RNG_RNG_SR_CECS_B_0x0 = 0x0
	// The RNG clock is too slow (fRNGCLK< fHCLK/32).
	RNG_RNG_SR_CECS_B_0x1 = 0x1
	// Position of SECS field.
	RNG_RNG_SR_SECS_Pos = 0x2
	// Bit mask of SECS field.
	RNG_RNG_SR_SECS_Msk = 0x4
	// Bit SECS.
	RNG_RNG_SR_SECS = 0x4
