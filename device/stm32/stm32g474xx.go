...
//go:build stm32 && stm32g474xx
// +build stm32,stm32g474xx
...
const (
	...
	IRQ_HRTIM_Master_IRQn = 67

	// High Resolution Timer: TIMA
	IRQ_HRTIM_TIMA_IRQn = 68

	// High Resolution Timer: TIMB
	IRQ_HRTIM_TIMB_IRQn = 69

	// High Resolution Timer: TIMC
	IRQ_HRTIM_TIMC_IRQn = 70

	// High Resolution Timer: TIMD
	IRQ_HRTIM_TIMD_IRQn = 71

	// High Resolution Timer: TIMF
	IRQ_HRTIM_TIME_IRQn = 72

	// High Resolution Timer: Common functions
	IRQ_HRTIM_TIM_FLT_IRQn = 73

	// High Resolution Timer: TIMF
	IRQ_HRTIM_TIMF_IRQn = 74
...
//export HRTIM_Master_IRQn_IRQHandler
func interruptHRTIM_Master_IRQn() {
	callHandlers(IRQ_HRTIM_Master_IRQn)
}

//export HRTIM_TIMA_IRQn_IRQHandler
func interruptHRTIM_TIMA_IRQn() {
	callHandlers(IRQ_HRTIM_TIMA_IRQn)
}

//export HRTIM_TIMB_IRQn_IRQHandler
func interruptHRTIM_TIMB_IRQn() {
	callHandlers(IRQ_HRTIM_TIMB_IRQn)
}

//export HRTIM_TIMC_IRQn_IRQHandler
func interruptHRTIM_TIMC_IRQn() {
	callHandlers(IRQ_HRTIM_TIMC_IRQn)
}

//export HRTIM_TIMD_IRQn_IRQHandler
func interruptHRTIM_TIMD_IRQn() {
	callHandlers(IRQ_HRTIM_TIMD_IRQn)
}

//export HRTIM_TIME_IRQn_IRQHandler
func interruptHRTIM_TIME_IRQn() {
	callHandlers(IRQ_HRTIM_TIME_IRQn)
}

//export HRTIM_TIM_FLT_IRQn_IRQHandler
func interruptHRTIM_TIM_FLT_IRQn() {
	callHandlers(IRQ_HRTIM_TIM_FLT_IRQn)
}

//export HRTIM_TIMF_IRQn_IRQHandler
func interruptHRTIM_TIMF_IRQn() {
	callHandlers(IRQ_HRTIM_TIMF_IRQn)
}
...
var (
	...
	// High Resolution Timer: Master Timers
	HRTIM_Master = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016800)))

	// High Resolution Timer: TIMA
	HRTIM_TIMA = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016880)))

	// High Resolution Timer: TIMB
	HRTIM_TIMB = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016900)))

	// High Resolution Timer: TIMC
	HRTIM_TIMC = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016980)))

	// High Resolution Timer: TIMD
	HRTIM_TIMD = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016a00)))

	// High Resolution Timer: TIME
	HRTIM_TIME = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016a80)))

	// High Resolution Timer: TIMF
	HRTIM_TIMF = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016b00)))

	// High Resolution Timer: Common functions
	HRTIM_Common = (*HRTIM_Type)(unsafe.Pointer(uintptr(0x40016b80)))
...
const (
	...
	// Position of TFCEN field.
	HRTIM_MCR_TFCEN_Pos = 0x16
	// Bit mask of TFCEN field.
	HRTIM_MCR_TFCEN_Msk = 0x400000
	// Bit TFCEN.
	HRTIM_MCR_TFCEN = 0x400000
	...
	// Position of INTLVD field.
	HRTIM_MCR_INTLVD_Pos = 0x6
	// Bit mask of INTLVD field.
	HRTIM_MCR_INTLVD_Msk = 0xc0
	...
	// MDIER: HRTIM Master Timer DMA / Interrupt Enable Register
