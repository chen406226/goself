...
//go:build stm32 && stm32g4a1xx
// +build stm32,stm32g4a1xx
...
var (
	...
	// USB_FS_device
	USB_FS_device = (*USB_Type)(unsafe.Pointer(uintptr(0x40005c00)))
...
const (
	...
	SAI_ACR1_MCKEN_Pos = 0x1b
	// Bit mask of MCKEN field.
	SAI_ACR1_MCKEN_Msk = 0x8000000
	// Bit MCKEN.
	SAI_ACR1_MCKEN = 0x8000000
	// Position of OSR field.
	SAI_ACR1_OSR_Pos = 0x1a
	// Bit mask of OSR field.
	SAI_ACR1_OSR_Msk = 0x4000000
	// Bit OSR.
	SAI_ACR1_OSR = 0x4000000
	// Position of MCJDIV field.
	SAI_ACR1_MCJDIV_Pos = 0x14
	// Bit mask of MCJDIV field.
	SAI_ACR1_MCJDIV_Msk = 0x3f00000
	// Position of NODIV field.
	SAI_ACR1_NODIV_Pos = 0x13
	// Bit mask of NODIV field.
	SAI_ACR1_NODIV_Msk = 0x80000
	// Bit NODIV.
	SAI_ACR1_NODIV = 0x80000
	// Position of DMAEN field.
	SAI_ACR1_DMAEN_Pos = 0x11
	// Bit mask of DMAEN field.
	SAI_ACR1_DMAEN_Msk = 0x20000
	// Bit DMAEN.
	SAI_ACR1_DMAEN = 0x20000
	// Position of SAIAEN field.
	SAI_ACR1_SAIAEN_Pos = 0x10
	// Bit mask of SAIAEN field.
	SAI_ACR1_SAIAEN_Msk = 0x10000
	// Bit SAIAEN.
	SAI_ACR1_SAIAEN = 0x10000
	// Position of OutDri field.
	SAI_ACR1_OutDri_Pos = 0xd
	// Bit mask of OutDri field.
	SAI_ACR1_OutDri_Msk = 0x2000
	// Bit OutDri.
	SAI_ACR1_OutDri = 0x2000
	// Position of MONO field.
	SAI_ACR1_MONO_Pos = 0xc
	// Bit mask of MONO field.
	SAI_ACR1_MONO_Msk = 0x1000
	// Bit MONO.
	SAI_ACR1_MONO = 0x1000
	// Position of SYNCEN field.
	SAI_ACR1_SYNCEN_Pos = 0xa
	// Bit mask of SYNCEN field.
	SAI_ACR1_SYNCEN_Msk = 0xc00
	// Position of CKSTR field.
	SAI_ACR1_CKSTR_Pos = 0x9
	// Bit mask of CKSTR field.
	SAI_ACR1_CKSTR_Msk = 0x200
	// Bit CKSTR.
	SAI_ACR1_CKSTR = 0x200
	// Position of LSBFIRST field.
	SAI_ACR1_LSBFIRST_Pos = 0x8
	// Bit mask of LSBFIRST field.
	SAI_ACR1_LSBFIRST_Msk = 0x100
	// Bit LSBFIRST.
	SAI_ACR1_LSBFIRST = 0x100
	// Position of DS field.
	SAI_ACR1_DS_Pos = 0x5
	// Bit mask of DS field.
	SAI_ACR1_DS_Msk = 0xe0
	// Position of PRTCFG field.
	SAI_ACR1_PRTCFG_Pos = 0x2
	// Bit mask of PRTCFG field.
	SAI_ACR1_PRTCFG_Msk = 0xc
	// Position of MODE field.
	SAI_ACR1_MODE_Pos = 0x0
	// Bit mask of MODE field.
	SAI_ACR1_MODE_Msk = 0x3

	// ACR2: AConfiguration register 2
	// Position of COMP field.
	SAI_ACR2_COMP_Pos = 0xe
	// Bit mask of COMP field.
	SAI_ACR2_COMP_Msk = 0xc000
	// Position of CPL field.
	SAI_ACR2_CPL_Pos = 0xd
	// Bit mask of CPL field.
	SAI_ACR2_CPL_Msk = 0x2000
	// Bit CPL.
	SAI_ACR2_CPL = 0x2000
	// Position of MUTECN field.
	SAI_ACR2_MUTECN_Pos = 0x7
	// Bit mask of MUTECN field.
	SAI_ACR2_MUTECN_Msk = 0x1f80
	// Position of MUTEVAL field.
	SAI_ACR2_MUTEVAL_Pos = 0x6
	// Bit mask of MUTEVAL field.
	SAI_ACR2_MUTEVAL_Msk = 0x40
	// Bit MUTEVAL.
	SAI_ACR2_MUTEVAL = 0x40
	// Position of MUTE field.
	SAI_ACR2_MUTE_Pos = 0x5
	// Bit mask of MUTE field.
	SAI_ACR2_MUTE_Msk = 0x20
	// Bit MUTE.
	SAI_ACR2_MUTE = 0x20
	// Position of TRIS field.
	SAI_ACR2_TRIS_Pos = 0x4
	// Bit mask of TRIS field.
	SAI_ACR2_TRIS_Msk = 0x10
	// Bit TRIS.
	SAI_ACR2_TRIS = 0x10
	// Position of FFLUS field.
	SAI_ACR2_FFLUS_Pos = 0x3
	// Bit mask of FFLUS field.
	SAI_ACR2_FFLUS_Msk = 0x8
	// Bit FFLUS.
	SAI_ACR2_FFLUS = 0x8
	// Position of FTH field.
	SAI_ACR2_FTH_Pos = 0x0
	// Bit mask of FTH field.
	SAI_ACR2_FTH_Msk = 0x7

	// AFRCR: AFRCR
	// Position of FSOFF field.
	SAI_AFRCR_FSOFF_Pos = 0x12
	// Bit mask of FSOFF field.
	SAI_AFRCR_FSOFF_Msk = 0x40000
	// Bit FSOFF.
	SAI_AFRCR_FSOFF = 0x40000
	// Position of FSPOL field.
	SAI_AFRCR_FSPOL_Pos = 0x11
	// Bit mask of FSPOL field.
	SAI_AFRCR_FSPOL_Msk = 0x20000
	// Bit FSPOL.
	SAI_AFRCR_FSPOL = 0x20000
	// Position of FSDEF field.
	SAI_AFRCR_FSDEF_Pos = 0x10
	// Bit mask of FSDEF field.
	SAI_AFRCR_FSDEF_Msk = 0x10000
	// Bit FSDEF.
	SAI_AFRCR_FSDEF = 0x10000
	// Position of FSALL field.
	SAI_AFRCR_FSALL_Pos = 0x8
	// Bit mask of FSALL field.
	SAI_AFRCR_FSALL_Msk = 0x7f00
	// Position of FRL field.
	SAI_AFRCR_FRL_Pos = 0x0
	// Bit mask of FRL field.
	SAI_AFRCR_FRL_Msk = 0xff

	// ASLOTR: ASlot register
	// Position of SLOTEN field.
	SAI_ASLOTR_SLOTEN_Pos = 0x10
	// Bit mask of SLOTEN field.
	SAI_ASLOTR_SLOTEN_Msk = 0xffff0000
	// Position of NBSLOT field.
	SAI_ASLOTR_NBSLOT_Pos = 0x8
	// Bit mask of NBSLOT field.
	SAI_ASLOTR_NBSLOT_Msk = 0xf00
	// Position of SLOTSZ field.
	SAI_ASLOTR_SLOTSZ_Pos = 0x6
	// Bit mask of SLOTSZ field.
	SAI_ASLOTR_SLOTSZ_Msk = 0xc0
	// Position of FBOFF field.
	SAI_ASLOTR_FBOFF_Pos = 0x0
	// Bit mask of FBOFF field.
	SAI_ASLOTR_FBOFF_Msk = 0x1f

	// AIM: AInterrupt mask register2
	// Position of LFSDET field.
	SAI_AIM_LFSDET_Pos = 0x6
	// Bit mask of LFSDET field.
	SAI_AIM_LFSDET_Msk = 0x40
	// Bit LFSDET.
	SAI_AIM_LFSDET = 0x40
	// Position of AFSDETIE field.
	SAI_AIM_AFSDETIE_Pos = 0x5
	// Bit mask of AFSDETIE field.
	SAI_AIM_AFSDETIE_Msk = 0x20
	// Bit AFSDETIE.
	SAI_AIM_AFSDETIE = 0x20
	// Position of CNRDYIE field.
	SAI_AIM_CNRDYIE_Pos = 0x4
	// Bit mask of CNRDYIE field.
	SAI_AIM_CNRDYIE_Msk = 0x10
	// Bit CNRDYIE.
	SAI_AIM_CNRDYIE = 0x10
	// Position of FREQIE field.
	SAI_AIM_FREQIE_Pos = 0x3
	// Bit mask of FREQIE field.
	SAI_AIM_FREQIE_Msk = 0x8
	// Bit FREQIE.
	SAI_AIM_FREQIE = 0x8
	// Position of WCKCFG field.
	SAI_AIM_WCKCFG_Pos = 0x2
	// Bit mask of WCKCFG field.
	SAI_AIM_WCKCFG_Msk = 0x4
	// Bit WCKCFG.
	SAI_AIM_WCKCFG = 0x4
	// Position of MUTEDET field.
	SAI_AIM_MUTEDET_Pos = 0x1
	// Bit mask of MUTEDET field.
	SAI_AIM_MUTEDET_Msk = 0x2
	// Bit MUTEDET.
	SAI_AIM_MUTEDET = 0x2
	// Position of OVRUDRIE field.
	SAI_AIM_OVRUDRIE_Pos = 0x0
	// Bit mask of OVRUDRIE field.
	SAI_AIM_OVRUDRIE_Msk = 0x1
	// Bit OVRUDRIE.
	SAI_AIM_OVRUDRIE = 0x1

	// ASR: AStatus register
	// Position of FLVL field.
	SAI_ASR_FLVL_Pos = 0x10
	// Bit mask of FLVL field.
	SAI_ASR_FLVL_Msk = 0x70000
	// Position of LFSDET field.
	SAI_ASR_LFSDET_Pos = 0x6
	// Bit mask of LFSDET field.
	SAI_ASR_LFSDET_Msk = 0x40
	// Bit LFSDET.
	SAI_ASR_LFSDET = 0x40
	// Position of AFSDET field.
	SAI_ASR_AFSDET_Pos = 0x5
	// Bit mask of AFSDET field.
	SAI_ASR_AFSDET_Msk = 0x20
	// Bit AFSDET.
	SAI_ASR_AFSDET = 0x20
	// Position of CNRDY field.
	SAI_ASR_CNRDY_Pos = 0x4
	// Bit mask of CNRDY field.
	SAI_ASR_CNRDY_Msk = 0x10
	// Bit CNRDY.
	SAI_ASR_CNRDY = 0x10
	// Position of FREQ field.
	SAI_ASR_FREQ_Pos = 0x3
	// Bit mask of FREQ field.
	SAI_ASR_FREQ_Msk = 0x8
	// Bit FREQ.
	SAI_ASR_FREQ = 0x8
	// Position of WCKCFG field.
	SAI_ASR_WCKCFG_Pos = 0x2
	// Bit mask of WCKCFG field.
	SAI_ASR_WCKCFG_Msk = 0x4
	// Bit WCKCFG.
	SAI_ASR_WCKCFG = 0x4
	// Position of MUTEDET field.
	SAI_ASR_MUTEDET_Pos = 0x1
	// Bit mask of MUTEDET field.
	SAI_ASR_MUTEDET_Msk = 0x2
	// Bit MUTEDET.
	SAI_ASR_MUTEDET = 0x2
	// Position of OVRUDR field.
	SAI_ASR_OVRUDR_Pos = 0x0
	// Bit mask of OVRUDR field.
	SAI_ASR_OVRUDR_Msk = 0x1
	// Bit OVRUDR.
	SAI_ASR_OVRUDR = 0x1

	// ACLRFR: AClear flag register
	// Position of LFSDET field.
	SAI_ACLRFR_LFSDET_Pos = 0x6
	// Bit mask of LFSDET field.
	SAI_ACLRFR_LFSDET_Msk = 0x40
	// Bit LFSDET.
	SAI_ACLRFR_LFSDET = 0x40
	// Position of CAFSDET field.
	SAI_ACLRFR_CAFSDET_Pos = 0x5
	// Bit mask of CAFSDET field.
	SAI_ACLRFR_CAFSDET_Msk = 0x20
	// Bit CAFSDET.
	SAI_ACLRFR_CAFSDET = 0x20
	// Position of CNRDY field.
	SAI_ACLRFR_CNRDY_Pos = 0x4
	// Bit mask of CNRDY field.
	SAI_ACLRFR_CNRDY_Msk = 0x10
	// Bit CNRDY.
	SAI_ACLRFR_CNRDY = 0x10
	// Position of WCKCFG field.
	SAI_ACLRFR_WCKCFG_Pos = 0x2
	// Bit mask of WCKCFG field.
	SAI_ACLRFR_WCKCFG_Msk = 0x4
	// Bit WCKCFG.
	SAI_ACLRFR_WCKCFG = 0x4
	// Position of MUTEDET field.
	SAI_ACLRFR_MUTEDET_Pos = 0x1
	// Bit mask of MUTEDET field.
	SAI_ACLRFR_MUTEDET_Msk = 0x2
	// Bit MUTEDET.
	SAI_ACLRFR_MUTEDET = 0x2
	// Position of OVRUDR field.
	SAI_ACLRFR_OVRUDR_Pos = 0x0
	// Bit mask of OVRUDR field.
	SAI_ACLRFR_OVRUDR_Msk = 0x1
	// Bit OVRUDR.
	SAI_ACLRFR_OVRUDR = 0x1

	// ADR: AData register
	// Position of DATA field.
	SAI_ADR_DATA_Pos = 0x0
	// Bit mask of DATA field.
	SAI_ADR_DATA_Msk = 0xffffffff

	// BCR1: BConfiguration register 1
	// Position of MCKEN field.
	SAI_BCR1_MCKEN_Pos = 0x1b
	// Bit mask of MCKEN field.
	SAI_BCR1_MCKEN_Msk = 0x8000000
	// Bit MCKEN.
	SAI_BCR1_MCKEN = 0x8000000
	// Position of OSR field.
	SAI_BCR1_OSR_Pos = 0x1a
	// Bit mask of OSR field.
	SAI_BCR1_OSR_Msk = 0x4000000
	// Bit OSR.
	SAI_BCR1_OSR = 0x4000000
	// Position of MCJDIV field.
	SAI_BCR1_MCJDIV_Pos = 0x14
	// Bit mask of MCJDIV field.
	SAI_BCR1_MCJDIV_Msk = 0x3f00000
	// Position of NODIV field.
	SAI_BCR1_NODIV_Pos = 0x13
	// Bit mask of NODIV field.
	SAI_BCR1_NODIV_Msk = 0x80000
	// Bit NODIV.
	SAI_BCR1_NODIV = 0x80000
	// Position of DMAEN field.
	SAI_BCR1_DMAEN_Pos = 0x11
	// Bit mask of DMAEN field.
	SAI_BCR1_DMAEN_Msk = 0x20000
	// Bit DMAEN.
	SAI_BCR1_DMAEN = 0x20000
	// Position of SAIBEN field.
	SAI_BCR1_SAIBEN_Pos = 0x10
	// Bit mask of SAIBEN field.
	SAI_BCR1_SAIBEN_Msk = 0x10000
	// Bit SAIBEN.
	SAI_BCR1_SAIBEN = 0x10000
	// Position of OutDri field.
	SAI_BCR1_OutDri_Pos = 0xd
	// Bit mask of OutDri field.
	SAI_BCR1_OutDri_Msk = 0x2000
	// Bit OutDri.
	SAI_BCR1_OutDri = 0x2000
	// Position of MONO field.
	SAI_BCR1_MONO_Pos = 0xc
	// Bit mask of MONO field.
	SAI_BCR1_MONO_Msk = 0x1000
	// Bit MONO.
	SAI_BCR1_MONO = 0x1000
	// Position of SYNCEN field.
	SAI_BCR1_SYNCEN_Pos = 0xa
	// Bit mask of SYNCEN field.
	SAI_BCR1_SYNCEN_Msk = 0xc00
	// Position of CKSTR field.
	SAI_BCR1_CKSTR_Pos = 0x9
	// Bit mask of CKSTR field.
	SAI_BCR1_CKSTR_Msk = 0x200
	// Bit CKSTR.
	SAI_BCR1_CKSTR = 0x200
	// Position of LSBFIRST field.
	SAI_BCR1_LSBFIRST_Pos = 0x8
	// Bit mask of LSBFIRST field.
	SAI_BCR1_LSBFIRST_Msk = 0x100
	// Bit LSBFIRST.
	SAI_BCR1_LSBFIRST = 0x100
	// Position of DS field.
	SAI_BCR1_DS_Pos = 0x5
	// Bit mask of DS field.
	SAI_BCR1_DS_Msk = 0xe0
	// Position of PRTCFG field.
	SAI_BCR1_PRTCFG_Pos = 0x2
	// Bit mask of PRTCFG field.
	SAI_BCR1_PRTCFG_Msk = 0xc
	// Position of MODE field.
	SAI_BCR1_MODE_Pos = 0x0
	// Bit mask of MODE field.
	SAI_BCR1_MODE_Msk = 0x3

	// BCR2: BConfiguration register 2
	// Position of COMP field.
	SAI_BCR2_COMP_Pos = 0xe
	// Bit mask of COMP field.
	SAI_BCR2_COMP_Msk = 0xc000
	// Position of CPL field.
	SAI_BCR2_CPL_Pos = 0xd
	// Bit mask of CPL field.
	SAI_BCR2_CPL_Msk = 0x2000
	// Bit CPL.
	SAI_BCR2_CPL = 0x2000
	// Position of MUTECN field.
	SAI_BCR2_MUTECN_Pos = 0x7
	// Bit mask of MUTECN field.
	SAI_BCR2_MUTECN_Msk = 0x1f80
	// Position of MUTEVAL field.
	SAI_BCR2_MUTEVAL_Pos = 0x6
	// Bit mask of MUTEVAL field.
	SAI_BCR2_MUTEVAL_Msk = 0x40
	// Bit MUTEVAL.
	SAI_BCR2_MUTEVAL = 0x40
	// Position of MUTE field.
	SAI_BCR2_MUTE_Pos = 0x5
	// Bit mask of MUTE field.
	SAI_BCR2_MUTE_Msk = 0x20
	// Bit MUTE.
	SAI_BCR2_MUTE = 0x20
	// Position of TRIS field.
	SAI_BCR2_TRIS_Pos = 0x4
	// Bit mask of TRIS field.
	SAI_BCR2_TRIS_Msk = 0x10
	// Bit TRIS.
	SAI_BCR2_TRIS = 0x10
	// Position of FFLUS field.
	SAI_BCR2_FFLUS_Pos = 0x3
	// Bit mask of FFLUS field.
	SAI_BCR2_FFLUS_Msk = 0x8
	// Bit FFLUS.
	SAI_BCR2_FFLUS = 0x8
	// Position of FTH field.
	SAI_BCR2_FTH_Pos = 0x0
	// Bit mask of FTH field.
	SAI_BCR2_FTH_Msk = 0x7

	// BFRCR: BFRCR
	// Position of FSOFF field.
	SAI_BFRCR_FSOFF_Pos = 0x12
	// Bit mask of FSOFF field.
	SAI_BFRCR_FSOFF_Msk = 0x40000
	// Bit FSOFF.
	SAI_BFRCR_FSOFF = 0x40000
	// Position of FSPOL field.
	SAI_BFRCR_FSPOL_Pos = 0x11
	// Bit mask of FSPOL field.
	SAI_BFRCR_FSPOL_Msk = 0x20000
	// Bit FSPOL.
	SAI_BFRCR_FSPOL = 0x20000
	// Position of FSDEF field.
	SAI_BFRCR_FSDEF_Pos = 0x10
	// Bit mask of FSDEF field.
	SAI_BFRCR_FSDEF_Msk = 0x10000
	// Bit FSDEF.
	SAI_BFRCR_FSDEF = 0x10000
	// Position of FSALL field.
	SAI_BFRCR_FSALL_Pos = 0x8
	// Bit mask of FSALL field.
	SAI_BFRCR_FSALL_Msk = 0x7f00
	// Position of FRL field.
	SAI_BFRCR_FRL_Pos = 0x0
	// Bit mask of FRL field.
	SAI_BFRCR_FRL_Msk = 0xff

	// BSLOTR: BSlot register
	// Position of SLOTEN field.
	SAI_BSLOTR_SLOTEN_Pos = 0x10
	// Bit mask of SLOTEN field.
	SAI_BSLOTR_SLOTEN_Msk = 0xffff0000
	// Position of NBSLOT field.
	SAI_BSLOTR_NBSLOT_Pos = 0x8
	// Bit mask of NBSLOT field.
	SAI_BSLOTR_NBSLOT_Msk = 0xf00
	// Position of SLOTSZ field.
	SAI_BSLOTR_SLOTSZ_Pos = 0x6
	// Bit mask of SLOTSZ field.
	SAI_BSLOTR_SLOTSZ_Msk = 0xc0
	// Position of FBOFF field.
	SAI_BSLOTR_FBOFF_Pos = 0x0
	// Bit mask of FBOFF field.
	SAI_BSLOTR_FBOFF_Msk = 0x1f

	// BIM: BInterrupt mask register2
	// Position of LFSDETIE field.
	SAI_BIM_LFSDETIE_Pos = 0x6
	// Bit mask of LFSDETIE field.
	SAI_BIM_LFSDETIE_Msk = 0x40
	// Bit LFSDETIE.
	SAI_BIM_LFSDETIE = 0x40
	// Position of AFSDETIE field.
	SAI_BIM_AFSDETIE_Pos = 0x5
	// Bit mask of AFSDETIE field.
	SAI_BIM_AFSDETIE_Msk = 0x20
	// Bit AFSDETIE.
	SAI_BIM_AFSDETIE = 0x20
	// Position of CNRDYIE field.
	SAI_BIM_CNRDYIE_Pos = 0x4
	// Bit mask of CNRDYIE field.
	SAI_BIM_CNRDYIE_Msk = 0x10
	// Bit CNRDYIE.
	SAI_BIM_CNRDYIE = 0x10
	// Position of FREQIE field.
	SAI_BIM_FREQIE_Pos = 0x3
	// Bit mask of FREQIE field.
	SAI_BIM_FREQIE_Msk = 0x8
	// Bit FREQIE.
	SAI_BIM_FREQIE = 0x8
	// Position of WCKCFG field.
	SAI_BIM_WCKCFG_Pos = 0x2
	// Bit mask of WCKCFG field.
	SAI_BIM_WCKCFG_Msk = 0x4
	// Bit WCKCFG.
	SAI_BIM_WCKCFG = 0x4
	// Position of MUTEDET field.
	SAI_BIM_MUTEDET_Pos = 0x1
	// Bit mask of MUTEDET field.
	SAI_BIM_MUTEDET_Msk = 0x2
	// Bit MUTEDET.
	SAI_BIM_MUTEDET = 0x2
	// Position of OVRUDRIE field.
	SAI_BIM_OVRUDRIE_Pos = 0x0
	// Bit mask of OVRUDRIE field.
	SAI_BIM_OVRUDRIE_Msk = 0x1
	// Bit OVRUDRIE.
	SAI_BIM_OVRUDRIE = 0x1

	// BSR: BStatus register
	// Position of FLVL field.
	SAI_BSR_FLVL_Pos = 0x10
	// Bit mask of FLVL field.
	SAI_BSR_FLVL_Msk = 0x70000
	// Position of LFSDET field.
	SAI_BSR_LFSDET_Pos = 0x6
	// Bit mask of LFSDET field.
	SAI_BSR_LFSDET_Msk = 0x40
	// Bit LFSDET.
	SAI_BSR_LFSDET = 0x40
	// Position of AFSDET field.
	SAI_BSR_AFSDET_Pos = 0x5
	// Bit mask of AFSDET field.
	SAI_BSR_AFSDET_Msk = 0x20
	// Bit AFSDET.
	SAI_BSR_AFSDET = 0x20
	// Position of CNRDY field.
	SAI_BSR_CNRDY_Pos = 0x4
	// Bit mask of CNRDY field.
	SAI_BSR_CNRDY_Msk = 0x10
	// Bit CNRDY.
	SAI_BSR_CNRDY = 0x10
	// Position of FREQ field.
	SAI_BSR_FREQ_Pos = 0x3
	// Bit mask of FREQ field.
	SAI_BSR_FREQ_Msk = 0x8
	// Bit FREQ.
	SAI_BSR_FREQ = 0x8
	// Position of WCKCFG field.
	SAI_BSR_WCKCFG_Pos = 0x2
	// Bit mask of WCKCFG field.
	SAI_BSR_WCKCFG_Msk = 0x4
	// Bit WCKCFG.
	SAI_BSR_WCKCFG = 0x4
	// Position of MUTEDET field.
	SAI_BSR_MUTEDET_Pos = 0x1
	// Bit mask of MUTEDET field.
	SAI_BSR_MUTEDET_Msk = 0x2
	// Bit MUTEDET.
	SAI_BSR_MUTEDET = 0x2
	// Position of OVRUDR field.
	SAI_BSR_OVRUDR_Pos = 0x0
	// Bit mask of OVRUDR field.
	SAI_BSR_OVRUDR_Msk = 0x1
	// Bit OVRUDR.
	SAI_BSR_OVRUDR = 0x1

	// BCLRFR: BClear flag register
	// Position of LFSDET field.
	SAI_BCLRFR_LFSDET_Pos = 0x6
	// Bit mask of LFSDET field.
	SAI_BCLRFR_LFSDET_Msk = 0x40
	// Bit LFSDET.
	SAI_BCLRFR_LFSDET = 0x40
	// Position of CAFSDET field.
	SAI_BCLRFR_CAFSDET_Pos = 0x5
	// Bit mask of CAFSDET field.
	SAI_BCLRFR_CAFSDET_Msk = 0x20
	// Bit CAFSDET.
	SAI_BCLRFR_CAFSDET = 0x20
	// Position of CNRDY field.
	SAI_BCLRFR_CNRDY_Pos = 0x4
	// Bit mask of CNRDY field.
	SAI_BCLRFR_CNRDY_Msk = 0x10
	// Bit CNRDY.
	SAI_BCLRFR_CNRDY = 0x10
	// Position of WCKCFG field.
	SAI_BCLRFR_WCKCFG_Pos = 0x2
	// Bit mask of WCKCFG field.
	SAI_BCLRFR_WCKCFG_Msk = 0x4
	// Bit WCKCFG.
	SAI_BCLRFR_WCKCFG = 0x4
	// Position of MUTEDET field.
	SAI_BCLRFR_MUTEDET_Pos = 0x1
	// Bit mask of MUTEDET field.
	SAI_BCLRFR_MUTEDET_Msk = 0x2
	// Bit MUTEDET.
	SAI_BCLRFR_MUTEDET = 0x2
	// Position of OVRUDR field.
	SAI_BCLRFR_OVRUDR_Pos = 0x0
	// Bit mask of OVRUDR field.
	SAI_BCLRFR_OVRUDR_Msk = 0x1
	// Bit OVRUDR.
	SAI_BCLRFR_OVRUDR = 0x1

	// BDR: BData register
	// Position of DATA field.
	SAI_BDR_DATA_Pos = 0x0
	// Bit mask of DATA field.
	SAI_BDR_DATA_Msk = 0xffffffff
...
// Bitfields for USB_FS_device: USB_FS_device
const (
