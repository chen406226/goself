...
// Bitfields for SYSCFG: System configuration controller and COMP register
const (
	...
	SYSCFG_COMP2_CSR_COMP2VALUE_Pos = 0x1e
	// Bit mask of COMP2VALUE field.
	SYSCFG_COMP2_CSR_COMP2VALUE_Msk = 0x40000000
	// Bit COMP2VALUE.
	SYSCFG_COMP2_CSR_COMP2VALUE = 0x40000000
	// Comparator values are not equal
...
const (
	...
	ADC_CCR_VLCDEN_Disabled = 0x0
	// VLCD reading circuitry enabled
	ADC_CCR_VLCDEN_Enabled = 0x1
